import{c as w,a as I,o as p,h as T,r as m,y as B,D as U,z as t,A as k,E as s,m as a,j as N}from"./iframe-BzpaBgH4.js";import{I as f}from"./caret-down-CDR-lWVb.js";import{_ as r,W as S,S as h,T as j,I as _}from"./UiTextbox-CzJ1LZqo.js";import{o as b}from"./utils-BqzVSXwn.js";import{j as e}from"./jsx-runtime-D34IIhkc.js";import{useMDXComponents as g}from"./index-C-cn5rLx.js";import{T as c}from"./ToReact-Cla_iBtP.js";import"./preload-helper-PPVm8Dsz.js";import"./composables-BsWAZrdj.js";import"./plugin-B_50sdWD.js";import"./index-BAxMPZdI.js";import"./index-Bs7sCYJD.js";const C={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"};function E(i,n){return p(),w("svg",C,[...n[0]||(n[0]=[I("path",{fill:"currentColor","fill-rule":"evenodd",d:"m16.333 15.072 3.556 3.56a.445.445 0 0 1-.018.613l-.622.623a.445.445 0 0 1-.631 0l-3.556-3.56a2.3 2.3 0 0 1-.266-.32l-.667-.89a6.22 6.22 0 0 1-3.885 1.362A6.232 6.232 0 0 1 7.531 4.613a6.22 6.22 0 0 1 7.572 1.753 6.235 6.235 0 0 1-.04 7.78l.888.614q.209.134.382.312M5.8 10.23c0 2.458 1.99 4.45 4.445 4.45 1.178 0 2.309-.469 3.142-1.303a4.453 4.453 0 0 0-3.142-7.597 4.447 4.447 0 0 0-4.445 4.45","clip-rule":"evenodd"},null,-1)])])}const v={render:E},d=T({__name:"UiTextbox.example",props:{id:{},type:{},value:{default:""},max:{},min:{},step:{},required:{type:Boolean},autocomplete:{},inputmode:{},maxlength:{},decimals:{},size:{},width:{},placeholder:{},prefix:{},suffix:{},active:{type:Boolean},autofocus:{type:Boolean},autoselect:{type:Boolean},clearable:{type:Boolean},readonly:{type:Boolean},disabled:{type:Boolean},invalid:{type:Boolean},multiline:{type:Boolean},rows:{},cols:{},outlined:{type:Boolean,default:!0},autofit:{type:Boolean},inputAttributes:{},withLeadingIcon:{type:Boolean,default:!1},withTrailingIcon:{type:Boolean,default:!1}},setup(i){const n=i,o=m(n.value);return(L,x)=>(p(),B(r,k({value:o.value,"onUpdate:value":x[0]||(x[0]=y=>o.value=y)},s(b)(n,["value","withLeadingIcon","withTrailingIcon"])),U({_:2},[i.withLeadingIcon?{name:"leading-icon",fn:t(()=>[a(s(v),{"aria-hidden":"true"})]),key:"0"}:void 0,i.withTrailingIcon?{name:"trailing-icon",fn:t(()=>[a(s(f),{"aria-hidden":"true"})]),key:"1"}:void 0]),1040,["value"]))}});d.__docgenInfo={exportName:"default",displayName:"UiTextbox.example",description:"",tags:{},props:[{name:"value",defaultValue:{func:!1,value:"''"}},{name:"outlined",defaultValue:{func:!1,value:"true"}},{name:"withLeadingIcon",defaultValue:{func:!1,value:"false"}},{name:"withTrailingIcon",defaultValue:{func:!1,value:"false"}}],sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiTextbox.example.vue"]};function u(i){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",ul:"ul",...g(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"uitextbox",children:"UiTextbox"}),`
...
`,e.jsx("span",{className:"d-inline-block mb-3",children:e.jsx(c,{is:d,placeholder:"Введите текст"})}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"autofit"})," – Автоподгонка ширины ",e.jsx(n.code,{children:"input/textarea"})," по мере ввода. Тип: ",e.jsx(n.code,{children:"boolean"}),". По умолчанию: ",e.jsx(n.code,{children:"false"}),". Примечание: итоговая ширина ограничена ",e.jsx(n.code,{children:"max-width"})," корневого элемента компонента."]}),`
`]}),`
...
`,e.jsx("span",{className:"d-inline-block my-3",children:e.jsx(c,{is:d,tag:"span",prefix:"https://"})}),`
`]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"suffix"})," – задает текст в конце поля ввода:",e.jsx("br",{}),`
`,e.jsx("span",{className:"d-inline-block my-3",children:e.jsx(c,{is:d,tag:"span",suffix:"₽"})}),`
`]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"leading-icon"})," – для иконки в начале поля ввода:",e.jsx("br",{}),`
`,e.jsx("span",{className:"d-inline-block my-3",children:e.jsx(c,{is:d,tag:"span",withLeadingIcon:!0})}),`
`]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"trailing-icon"})," – для иконки в конце поля ввода:",e.jsx("br",{}),`
`,e.jsx("span",{className:"d-inline-block my-3",children:e.jsx(c,{is:d,tag:"span",withTrailingIcon:!0})}),`
`]}),`
`]}),`
`,e.jsxs(n.p,{children:["Пример задействования всех слотов:",e.jsx("br",{})]}),`
`,e.jsx("span",{className:"d-inline-block mb-3",children:e.jsx(c,{is:d,tag:"span",prefix:"https://",suffix:"₽",withLeadingIcon:!0,withTrailingIcon:!0})}),`
`,e.jsx("br",{}),`
`,e.jsx("span",{className:"d-inline-block my-3",children:e.jsx(c,{is:d,tag:"span",prefix:"https://",suffix:"₽",withLeadingIcon:!0,withTrailingIcon:!0,outlined:!1})}),`
...
const term = ref('')
<\/script>
`})})]})}function D(i={}){const{wrapper:n}={...g(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(u,{...i})}):u(i)}const H={title:"Components/UiTextbox",component:r,args:{id:void 0,type:j.TEXT,value:"",placeholder:"Enter text",size:h.SM,width:S.FIT,prefix:"https://",suffix:"₽",active:!1,invalid:!1,multiline:!1,autofit:!1},argTypes:{id:{control:!1},type:{control:"select",options:Object.values(j)},value:{control:"text"},width:{control:"text"},size:{control:"select",options:Object.values(h)},inputmode:{control:"select",options:Object.values(_)}},render:i=>({components:{IconCaret:f,IconSearch:v,UiTextbox:r},setup(){const{value:n}=i;return{value:m(String(n)),props:N(()=>b(i,["value"]))}},template:`
      <UiTextbox
          v-model:value="value"
          v-bind="props"
      >
    ...
    `}),parameters:{docs:{page:D},layout:"centered"}},l={};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"{}",...l.parameters?.docs?.source}}};const Y=["Sandbox"];export{l as Sandbox,Y as __namedExportsOrder,H as default};
