import"./uid-DWFSoHwe.js";/* empty css                   */import{h as C,c as h,k as d,z as i,D as T,A as M,r as m,o as f,N as r,t as N,a as p,H as k}from"./iframe-DnG3g5pW.js";import{_ as x}from"./UiButton-BCon8_Cd.js";import{_ as j,S as v,a as b,D as g}from"./UiModalSidebar-igOQlZ5g.js";import{u as S,j as e}from"./index-DFg_Ho_i.js";import{T as a}from"./ToReact-DbRAeBf3.js";import"./preload-helper-PPVm8Dsz.js";import"./predicate-ClulhfEu.js";import"./render-vaNyDQt4.js";import"./composables-CfEvSTVp.js";import"./UiScrollBox-r2qAVLZM.js";import"./UiTooltip-CRMFVV-V.js";import"./UiPopper-C8UHJnqx.js";import"./UiTransition-BqKpixzE.js";import"./clear-jf7bAM_2.js";import"./index-nl1gzEpR.js";const B={style:{height:"1500px"}},O={key:0,style:{"margin-top":"16px"}},l=C({__name:"UiModalSidebar.example",props:{buttonTitle:{type:String,default:""},hasNesting:{type:Boolean,default:!1},footer:{type:Boolean,default:!1}},setup(o){const n=m(!1),c=m(!1);return(U,s)=>(f(),h("div",null,[d(x,{onClick:s[0]||(s[0]=t=>n.value=!0)},{default:i(()=>[r(N(o.buttonTitle),1)]),_:1}),d(j,M({opened:n.value,"onUpdate:opened":s[6]||(s[6]=t=>n.value=t)},U.$attrs),T({title:i(()=>[s[7]||(s[7]=r(" Заголовок ",-1))]),default:i(()=>[p("div",B,[s[12]||(s[12]=p("div",null,"Контент высотой 1500px",-1)),o.hasNesting?(f(),h("div",O,[d(x,{onClick:s[1]||(s[1]=t=>c.value=!0)},{default:i(()=>[...s[8]||(s[8]=[r(" Вложенная шторка ",-1)])]),_:1}),d(j,{opened:c.value,"onUpdate:opened":s[3]||(s[3]=t=>c.value=t),onCloseSidebar:s[4]||(s[4]=t=>c.value=!1)},{title:i(()=>[...s[9]||(s[9]=[r(" Header ",-1)])]),footer:i(()=>[d(x,{onClick:s[2]||(s[2]=t=>c.value=!1)},{default:i(()=>[...s[10]||(s[10]=[r(" Закрыть ",-1)])]),_:1})]),default:i(()=>[s[11]||(s[11]=p("div",{style:{height:"1500px"}},[p("div",null,"Some content"),p("div",null,"Вложенная шторка")],-1))]),_:1},8,["opened"])])):k("",!0)])]),_:2},[o.footer?{name:"footer",fn:i(()=>[d(x,{onClick:s[5]||(s[5]=t=>n.value=!1)},{default:i(()=>[...s[13]||(s[13]=[r(" Закрыть ",-1)])]),_:1})]),key:"0"}:void 0]),1040,["opened"])]))}});l.__docgenInfo=Object.assign({displayName:l.name??l.__name},{exportName:"default",displayName:"UiModalSidebar.example",description:"",tags:{},props:[{name:"buttonTitle",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"hasNesting",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"footer",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiModalSidebar.example.vue"]});function y(o){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...S(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"uimodalsidebar",children:"UiModalSidebar"}),`
...
`,e.jsxs("div",{className:"flex-container gap-4",children:[e.jsx(a,{is:l,buttonTitle:"Открыть (sm)"}),e.jsx(a,{is:l,buttonTitle:"Открыть (lg)",size:"lg"})]}),`
...
ссылки на настройки.`}),`
`,e.jsx(a,{is:l,buttonTitle:"Левая панель (sm)",direction:"left"}),`
...
курсора.`]}),`
`,e.jsx(a,{is:l,buttonTitle:"Фиксированная панель (sm)",direction:"left",fixed:!0}),`
...
`,e.jsx(a,{is:l,buttonTitle:"Панель со вложенной шторкой (sm)",hasNesting:!0,footer:!0}),`
...
`,e.jsx(a,{is:l,buttonTitle:"Панель с заданными слотами",footer:!0}),`
