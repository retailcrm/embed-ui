import{c as j}from"./host-CMQl2KSi.js";import{S as r,A as o,_ as u,a as b}from"./UiTabGroup-BdIKH7S9.js";import{d as m,c as f}from"./createRemoteStoryRender-CQKxbukF.js";import{d as h}from"./docsOnlyStory-D04fiwRX.js";import{u as x,j as e}from"./index-DFg_Ho_i.js";import{S as d,A as v}from"./blocks-DBDDY4vL.js";import"./iframe-DnG3g5pW.js";import"./preload-helper-PPVm8Dsz.js";import"./UiPopperConnector-BFMd-LIm.js";import"./composables-CfEvSTVp.js";import"./UiPopper-C8UHJnqx.js";import"./UiButton-BCon8_Cd.js";import"./predicate-ClulhfEu.js";import"./render-vaNyDQt4.js";import"./UiMenuItem-CATQK8cQ.js";import"./index-nl1gzEpR.js";const w="UiTabGroup",T="UiTab";m(T,[],["default","icon","label","counter","content"]);const g=m(w,["layout","change","update:activeId","update:focusableId","update:menuExpanded"],["default"]);function S(i){return new Worker(""+new URL("UiTab.remote-CDNsdsnG.js",import.meta.url).href,{name:i?.name})}function p(i){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...x(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"uitab",children:"UiTab"}),`
...
`,e.jsx(v,{})]})}function U(i={}){const{wrapper:n}={...x(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(p,{...i})}):p(i)}const E=j({UiTab:b,UiTabGroup:u}),F={title:"Components/UiTab",component:g,argTypes:{activeId:{control:!1},items:{control:!1},size:{control:"select",options:Object.values(r)},appearance:{control:"select",options:Object.values(o)},overflowing:{control:"boolean"},withSlots:{control:"boolean"},withContent:{control:"boolean"},containerWidth:{control:{type:"number",min:240,max:960,step:20}}},render:f({provider:E,worker:S}),parameters:{docs:{page:U},layout:"padded"}},a={args:{appearance:o.TEXT,size:r.MD,overflowing:!0,withSlots:!0,withContent:!0,containerWidth:560}},t=h({args:{appearance:o.TEXT,size:r.MD,overflowing:!0,withSlots:!1,withContent:!1,containerWidth:560}}),s=h({args:{appearance:o.TEXT,size:r.MD,overflowing:!0,withSlots:!0,withContent:!0,containerWidth:560}}),c=h({args:{appearance:o.TEXT,size:r.MD,overflowing:!0,withSlots:!0,withContent:!0,containerWidth:320}}),l=h({args:{appearance:o.FILLED,size:r.MD,overflowing:!1,withSlots:!0,withContent:!0,containerWidth:560}});a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
...
})`,...l.parameters?.docs?.source}}};const Z=["Sandbox","BasicTabs","IconTabs","OverflowMenu","FilledTabs"];export{t as BasicTabs,l as FilledTabs,s as IconTabs,c as OverflowMenu,a as Sandbox,Z as __namedExportsOrder,F as default};
