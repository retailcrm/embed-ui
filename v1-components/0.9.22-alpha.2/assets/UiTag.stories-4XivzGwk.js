import{_ as i,S as c}from"./UiTag-C_AWhmbM.js";import{u as l,j as e}from"./index-DC6AVhol.js";import{T as t}from"./ToReact-C7vZiqYZ.js";import{h as x,s as m,w as u,A as g,B as p,o as d,c as h,D as j,E as b,F as f,y as k}from"./iframe-DDyl2AmK.js";import"./clear-DNT8teyS.js";import"./plugin-DBXjfIqs.js";import"./index-BAxMPZdI.js";import"./index-CDnKqZOh.js";import"./preload-helper-PPVm8Dsz.js";const r=x({__name:"UiTag.example",props:{text:{type:String,default:""}},setup(n){return(s,T)=>(d(),m(i,g(p(s.$attrs)),{default:u(()=>[n.text.length?(d(),h(f,{key:0},[j(b(n.text),1)],64)):k("",!0)]),_:1},16))}});r.__docgenInfo=Object.assign({displayName:r.name??r.__name},{exportName:"default",displayName:"UiTag.example",description:"",tags:{},props:[{name:"text",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiTag.example.vue"]});function o(n){const s={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...l(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.h1,{id:"uitag",children:"UiTag"}),`
...
<\/script>
`})})]})}function v(n={}){const{wrapper:s}={...l(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(o,{...n})}):o(n)}const F={title:"Components/UiTag",component:i,args:{size:c.LG,background:"#66d2b6",saturated:!0},argTypes:{size:{control:"select",options:Object.values(c)},icon:{control:!1},default:{control:!1},"remove-icon":{control:!1}},render:n=>({components:{UiTag:i},setup(){return{args:n}},template:`
      <UiTag v-bind="args">
        Free text
      </UiTag>
    `}),parameters:{docs:{page:v},layout:"centered"}},a={};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"{}",...a.parameters?.docs?.source}}};const I=["Sandbox"];export{a as Sandbox,I as __namedExportsOrder,F as default};
