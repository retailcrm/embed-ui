...
`]})]})}function Me(i={}){const{wrapper:n}={...J(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(H,{...i})}):H(i)}const Re={title:"Components/UiModalSidebar",component:w,args:{direction:v.RIGHT,fixed:!1,scrolling:p.NORMAL,size:x.SM},argTypes:{opened:{control:!1},id:{control:!1},direction:{control:"select",options:Object.values(v)},scrolling:{control:"select",options:Object.values(p)},size:{control:"select",options:Object.values(x)}},render:i=>({components:{UiButton:y,UiModalSidebar:w},setup(){return{args:i,opened:S(!1)}},template:`
      <div>
    ...
    `}),parameters:{docs:{page:Me},layout:"centered"}},O={};var P,X,Y;O.parameters={...O.parameters,docs:{...(P=O.parameters)==null?void 0:P.docs,source:{originalSource:"{}",...(Y=(X=O.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};const De=["Sandbox"];export{O as Sandbox,De as __namedExportsOrder,Re as default};
