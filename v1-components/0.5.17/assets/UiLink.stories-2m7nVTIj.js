...
`]})]})}function N(i={}){const{wrapper:s}={...j(),...i.components};return s?e.jsx(s,{...i,children:e.jsx(o,{...i})}):o(i)}const B={title:"Components/UiLink",component:l,args:{appearance:c.DEFAULT,size:a.BODY},argTypes:{appearance:{control:"select",options:Object.values(c)},size:{control:"select",options:Object.values(a)},default:{control:!1},icon:{control:!1}},render:i=>({components:{UiLink:l},setup(){return{args:i}},template:`
      <UiLink v-bind="args">
          Hyperlink
      </UiLink>
    `}),parameters:{docs:{page:N},layout:"centered"}},r={};var x,p,h;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:"{}",...(h=(p=r.parameters)==null?void 0:p.docs)==null?void 0:h.source}}};const I=["Sandbox"];export{r as Sandbox,I as __namedExportsOrder,B as default};
