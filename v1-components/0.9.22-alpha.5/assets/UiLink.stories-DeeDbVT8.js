import{_ as l,S as a,A as c}from"./UiLink-f-kEUVeW.js";import{u as x,j as e}from"./index-CuXuO6Th.js";import{T as t}from"./ToReact-Dv9qpzOJ.js";import{h,s as p,w as j,A as m,B as u,o as d,c as g,D as f,E as y,F as k,y as b}from"./iframe-BEtgrgln.js";import"./predicate-ClulhfEu.js";import"./composables-Cdrv47wY.js";import"./index-BlM3-phh.js";import"./preload-helper-PPVm8Dsz.js";const n=h({__name:"UiLink.example",props:{text:{type:String,default:""}},setup(i){return(s,_)=>(d(),p(l,m(u(s.$attrs)),{default:j(()=>[i.text.length?(d(),g(k,{key:0},[f(y(i.text),1)],64)):b("",!0)]),_:1},16))}});n.__docgenInfo=Object.assign({displayName:n.name??n.__name},{exportName:"default",displayName:"UiLink.example",description:"",tags:{},props:[{name:"text",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiLink.example.vue"]});function o(i){const s={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...x(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.h1,{id:"uilink",children:"UiLink"}),`
...
`]})]})}function v(i={}){const{wrapper:s}={...x(),...i.components};return s?e.jsx(s,{...i,children:e.jsx(o,{...i})}):o(i)}const S={title:"Components/UiLink",component:l,args:{appearance:c.DEFAULT,size:a.BODY},argTypes:{appearance:{control:"select",options:Object.values(c)},size:{control:"select",options:Object.values(a)},default:{control:!1},icon:{control:!1}},render:i=>({components:{UiLink:l},setup(){return{args:i}},template:`
      <UiLink v-bind="args">
          Hyperlink
      </UiLink>
    `}),parameters:{docs:{page:v},layout:"centered"}},r={};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"{}",...r.parameters?.docs?.source}}};const B=["Sandbox"];export{r as Sandbox,B as __namedExportsOrder,S as default};
