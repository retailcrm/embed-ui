import{_ as i}from"./UiScrollBox-BRcqdZww.js";import{j as s}from"./index-Djyvt97q.js";import{useMDXComponents as m}from"./index-Cdf3Trmt.js";import{T as t}from"./ToReact-Duu_YiOS.js";import{g as h,c as _,k as l,w as a,s as d,n as c,o as j,a as p}from"./iframe-w9uXPWTm.js";import{_ as f}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-B44Kv34C.js";import"./preload-helper-PPVm8Dsz.js";const x=h({__name:"UiScrollBox.example",setup(o){return(e,q)=>(j(),_("div",{class:c(e.$style.wrapper)},[l(i,d(e.$attrs,{class:e.$style.block}),{default:a(()=>[p("div",{class:c([e.$style.content,e.$style.content_tall])},null,2)]),_:1},16,["class"]),l(i,d(e.$attrs,{class:e.$style.block}),{default:a(()=>[p("div",{class:c([e.$style.content,e.$style.content_wide])},null,2)]),_:1},16,["class"])],2))}}),y="_wrapper_6iu54_1",b="_block_6iu54_4",g="_content_6iu54_13",w="_content_wide_6iu54_17",B="_content_tall_6iu54_20",S={wrapper:y,block:b,content:g,content_wide:w,content_tall:B},k={$style:S},n=f(x,[["__cssModules",k]]);x.__docgenInfo={exportName:"default",displayName:"UiScrollBox.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiScrollBox.example.vue"]};function u(o){const e={code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",...m(),...o.components};return s.jsxs(s.Fragment,{children:[s.jsx(e.h1,{id:"uiscrollbox",children:"UiScrollBox"}),`
...
`,s.jsxs(e.p,{children:["Для размещения контента используется слот по-умолчанию ",s.jsx(e.code,{children:"default"}),"."]})]})}function $(o={}){const{wrapper:e}={...m(),...o.components};return e?s.jsx(e,{...o,children:s.jsx(u,{...o})}):u(o)}const D={title:"Components/UiScrollBox",component:i,argTypes:{default:{control:!1}},render:o=>({components:{UiScrollBox:i},setup(){return{args:o}},data:()=>({styles:{height:"250px",width:"300px",padding:"0px 16px 16px",border:"1px solid rgba(30, 34, 72, 0.16)",borderRadius:"4px"}}),template:`
    ...
    `}),parameters:{docs:{page:$},layout:"centered"}},r={};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"{}",...r.parameters?.docs?.source}}};const E=["Sandbox"];export{r as Sandbox,E as __namedExportsOrder,D as default};
