import{j as e}from"./index-Djyvt97q.js";import{useMDXComponents as l}from"./index-Cdf3Trmt.js";function s(r){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"галерея-vue-компонентов-для-js-модулей",children:"Галерея Vue-компонентов для JS-модулей"}),`
...
`]})]})}function c(r={}){const{wrapper:n}={...l(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(s,{...r})}):s(r)}export{c as default};
