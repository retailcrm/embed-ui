...
`,s.jsxs(e.p,{children:["Для размещения контента используется слот по-умолчанию ",s.jsx(e.code,{children:"default"}),"."]})]})}function $(o={}){const{wrapper:e}={...x(),...o.components};return e?s.jsx(e,{...o,children:s.jsx(m,{...o})}):m(o)}const A={title:"Components/UiScrollBox",component:a,argTypes:{default:{control:!1}},render:o=>({components:{UiScrollBox:a},setup(){return{args:o}},data:()=>({styles:{height:"250px",width:"300px",padding:"0px 16px 16px",border:"1px solid rgba(30, 34, 72, 0.16)",borderRadius:"4px"}}),template:`
    ...
    `}),parameters:{docs:{page:$},layout:"centered"}},r={};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"{}",...r.parameters?.docs?.source}}};const D=["Sandbox"];export{r as Sandbox,D as __namedExportsOrder,A as default};
