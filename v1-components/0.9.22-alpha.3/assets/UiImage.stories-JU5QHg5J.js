import{_ as c}from"./UiImage-BusBqEVS.js";import{u as d,j as e}from"./index-DC6AVhol.js";import"./iframe-DDyl2AmK.js";import"./preload-helper-PPVm8Dsz.js";function i(s){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...d(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"uiimage",children:"UiImage"}),`
...
`})})]})}function t(s={}){const{wrapper:n}={...d(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}const x={title:"Components/UiImage",component:c,args:{src:"https://on-desktop.com/wps/Animals___Cats_Red_Cat_with_open_mouth_044663_.jpg",resize:"200x-"},render:s=>({components:{UiImage:c},setup:()=>({args:s}),template:'<UiImage v-bind="args" />'}),parameters:{docs:{page:t},layout:"centered"}},r={};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"{}",...r.parameters?.docs?.source}}};const p=["Sandbox"];export{r as Sandbox,p as __namedExportsOrder,x as default};
