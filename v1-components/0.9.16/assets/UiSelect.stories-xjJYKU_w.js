import{h as Ge}from"./host-JI2wTRpI.js";import{S as re,_ as Ke}from"./UiMenuItem-Coadc8Ox.js";import{P as X,_ as se,u as le,h as Ve,S as Ne,a as Ae,b as Be,U as Pe}from"./UiSelectTrigger-Bd6Z1hpR.js";import{_ as Fe}from"./UiPopperConnector-mjhANbIe.js";import{h as _,O as Re,j as d,r as y,a4 as qe,p as c,w as G,y as J,z as b,E as j,i as m,o as T,m as z,A as ne,c as D,t as Y,H as fe,q as k,a as ee,a5 as ze,U as ve,D as he,P as De,N as de}from"./iframe-DCDVANl5.js";import{d as W,a as O,n as We,c as Le}from"./createRemoteStoryRender-m6VBwp-6.js";import{a as Ze}from"./popper-zTN3MKKN.js";import{S as ce}from"./UiTextbox-Dschc3ky.js";import{I as _e}from"./plugin-DGcvpriV.js";import{b as Qe}from"./UiPopper-BfZHweql.js";import{I as Xe}from"./checkmark-circle-DlToI2zP.js";import{d as K}from"./docsOnlyStory-D04fiwRX.js";import{j as l}from"./jsx-runtime-CUtLY3pZ.js";import{useMDXComponents as ge}from"./index-DwIA-ESQ.js";import{S as C,A as Je}from"./blocks-Cr0w7RcH.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./composables-ACcgJ6G0.js";import"./caret-down-DdT2bKXv.js";import"./index-BAxMPZdI.js";import"./preload-helper-PPVm8Dsz.js";import"./index-EpkwYzaG.js";const ye=Symbol("UiSelectedIsSelected"),be=Symbol("UiSelectRegister"),Se=Symbol("UiSelectSync"),xe=Symbol("UiSelectUnregister"),Ue=Symbol("UiSelectToggle"),Oe=Symbol("UiSelectFilter"),te=Symbol("UiSelectFiltered"),je=Symbol("UiSelectTicker"),ke=Symbol("UiSelectMultiple"),Ie=Symbol("UiSelectActiveOptionId"),ae=Symbol("UiSelectFastened"),ie=Symbol("UiSelectUnregisterOption"),oe=Symbol("UiSelectRegisterOption"),ue=Symbol("UiSelectOptionGroupRegister"),pe=Symbol("UiSelectOptionGroupUnregister"),Te=Symbol("UiSelectOptionGroupRegisterHeaderOption"),Ee=Symbol("UiSelectOptionGroupUnregisterHeaderOption"),Ye="UiSelectTrigger",el=W(Ye,{emits:["input","focus","blur","keydown","clear","update:value","update:expanded"],methods:{open:O(),close:O(),onClick:O(),onKeyDown:O(),onInput:O(),onFocus:O(),onBlur:O(),onClear:O()}}),ll="UiSelectPopper",nl=W(ll,{emits:["update:visible","show","hide","shown","hidden","dispose"],methods:{autoScroll:O(),updateWidth:O()}}),tl="UiSelectOption";W(tl);const al={key:0,class:"ui-v1-select__no-results-text"},we=_({inheritAttrs:!1,__name:"UiSelect",props:{id:{type:String,default:void 0},value:{type:null},placeholder:{type:String,default:"test"},clearable:{type:Boolean,default:!1},filterable:{type:Boolean,default:!1},invalid:{type:Boolean,default:!1},readonly:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1},equalsFn:{type:Function,default:(a,e)=>a===e},placement:{type:String,validator:a=>Object.values(X).includes(a),default:X.BOTTOM},targetTriggers:{type:[Array,Object],default:()=>({show:["click"]})},popperTriggers:{type:[Array,Object],default:()=>[]},popperFitTrigger:{type:Boolean,default:!1},popperClass:{type:String,default:null},popperOptions:{type:Object,default:()=>({})},textboxSize:{type:String,validator:a=>Object.values(ce).includes(a),default:ce.SM},multiple:{type:Boolean,default:!1},expanded:{type:Boolean,default:!1},placeholderOnly:{type:Boolean,default:!1},ticker:{type:Boolean,default:!1}},setup(a){const e=a,t=Re({expanded:e.expanded,filter:"",value:e.value}),S=le("ui-v1-select"),x=d(()=>e.id??S),E=d(()=>se.init(m(_e,null)?.locale??se.fallback)),M=d(()=>E.value.t("search.noResult",{filter:t.filter})),v=y([]),u=y(null),U=qe("popper"),H=d(()=>{const n=w(t.value),i=[];return n.forEach(r=>{const p=v.value.find($=>o($.value,r));p&&i.push(p)}),i}),w=n=>Array.isArray(n)?[...n]:typeof n=="number"||typeof n=="boolean"||n?[n]:[],o=(n,i)=>e.equalsFn(n,i),s=(n,i)=>n.some(r=>o(r,i)),h=d(()=>v.value.filter(n=>n.isMatched()&&!n.disabled));c(be,n=>{if(v.value.some(i=>i.id===n.id))throw new Error(`[UiSelect] Component with id ${n.id} already registered. Unregister it before using again.`);v.value.push(n)}),c(Se,(n,i)=>{const r=v.value.find(p=>p.id===n);r&&(r.label=i.label,r.value=i.value,r.disabled=i.disabled)}),c(xe,n=>{const i=v.value.findIndex(r=>r.id===n);i!==-1&&v.value.splice(i,1)}),c(ye,d(()=>n=>Array.isArray(t.value)?s(t.value,n):o(t.value,n))),c(Ue,n=>{if(e.multiple){const i=w(t.value),r=i.findIndex(p=>o(p,n));r!==-1?i.splice(r,1):i.push(n),t.value=i,e.multiple||f()}else t.value=n,f()}),c(Oe,d(()=>t.filter)),c(te,d(()=>e.filterable&&t.filter.length>0)),c(je,d(()=>e.ticker)),c(ke,d(()=>e.multiple)),c(Ie,d(()=>u.value));const Q=n=>{t.filter=n},g=(n="selected-first")=>{const i=h.value;if(i.length===0){u.value=null;return}if(n==="first"){u.value=i[0].id;return}if(n==="last"){u.value=i[i.length-1].id;return}const r=i.find(p=>Array.isArray(t.value)?s(t.value,p.value):o(t.value,p.value));u.value=r?.id??i[0].id},I=n=>{const i=h.value;if(i.length===0){u.value=null;return}const r=i.findIndex($=>$.id===u.value),p=r===-1?n>0?0:i.length-1:(r+n+i.length)%i.length;u.value=i[p].id},L=()=>{const n=h.value.find(i=>i.id===u.value);if(n)if(e.multiple){const i=w(t.value),r=i.findIndex(p=>o(p,n.value));r!==-1?i.splice(r,1):i.push(n.value),t.value=i}else t.value=n.value,f()},V=n=>{if(!(e.disabled||e.readonly)){if(n.key==="Escape"){f();return}if(n.key==="Tab"){f();return}if(n.key==="Home"){t.expanded||(t.expanded=!0),g("first");return}if(n.key==="End"){t.expanded||(t.expanded=!0),g("last");return}if(n.key==="ArrowDown"){if(!t.expanded){t.expanded=!0,g("first");return}I(1);return}if(n.key==="ArrowUp"){if(!t.expanded){t.expanded=!0,g("last");return}I(-1);return}if(n.key==="Enter"){if(!t.expanded){t.expanded=!0,g("selected-first");return}L()}}},f=()=>{t.expanded&&(t.expanded=!1,t.filter="",u.value=null)},N=async()=>{t.expanded&&(await We(),await U.value?.updateWidth(),await U.value?.autoScroll())};return G(()=>e.expanded,n=>{t.expanded=n,n||(t.filter="",u.value=null)}),G(()=>e.value,n=>{t.value=n}),G(()=>t.expanded,n=>{n?(g("selected-first"),N()):u.value=null}),G(h,()=>{if(!t.expanded)return;h.value.some(i=>i.id===u.value)||(g("selected-first"),N())}),G(u,(n,i)=>{!t.expanded||n===i||N()}),(n,i)=>(T(),J(j(Ze),null,{default:b(()=>[z(j(el),ne({id:x.value,value:t.value,multiple:a.multiple,selection:H.value,filter:t.filter,filterable:a.filterable,clearable:a.clearable,expanded:t.expanded,invalid:a.invalid,disabled:a.disabled,readonly:a.readonly,"placeholder-only":a.placeholderOnly,placeholder:a.placeholder,"textbox-size":a.textboxSize,"active-descendant":u.value},n.$attrs,{onInput:Q,onKeydown:V,"onUpdate:value":i[0]||(i[0]=r=>t.value=r),"onUpdate:expanded":i[1]||(i[1]=r=>t.expanded=r)}),null,16,["id","value","multiple","selection","filter","filterable","clearable","expanded","invalid","disabled","readonly","placeholder-only","placeholder","textbox-size","active-descendant"]),z(j(nl),{id:x.value,ref_key:"popper",ref:U,disabled:a.disabled||a.readonly,multiple:a.multiple,opened:t.expanded,placement:a.placement,"popper-class":a.popperClass,"popper-fit-trigger":a.popperFitTrigger,"popper-options":a.popperOptions,"popper-triggers":a.popperTriggers,readonly:a.readonly,"target-triggers":a.targetTriggers,ticker:a.ticker,filterable:a.filterable,"options-registry":v.value,onHide:f},{default:b(()=>[a.filterable&&v.value.every(r=>!r.isMatched())&&M.value?(T(),D("div",al,Y(M.value),1)):fe("",!0),k(n.$slots,"default")]),_:3},8,["id","disabled","multiple","opened","placement","popper-class","popper-fit-trigger","popper-options","popper-triggers","readonly","target-triggers","ticker","filterable","options-registry"])]),_:3}))}});we.__docgenInfo={exportName:"default",displayName:"UiSelect",description:"",tags:{},props:[{name:"id",description:"Атрибут id корневого элемента выпадающего списка. Должен быть уникальным на странице",type:{name:"string"},defaultValue:{func:!1,value:"undefined"}},{name:"value",description:"Атрибут value, содержащий выбранный элемент из выпадающего списка",type:{name:"unknown|unknown[]"}},{name:"placeholder",description:"Атрибут placeholder нативного поля ввода input",type:{name:"string"},defaultValue:{func:!1,value:"'test'"}},{name:"clearable",description:"Отображает иконку сброса введённого или выбранного значения в виде крестика",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"filterable",description:"Фильтрация строк выпадающего списка на соответствие введённого выражения в input",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"invalid",description:"Подсвечивает поле как содержащее некорректное значение",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"readonly",description:"Устанавливает поле ввода в состояние доступное только для чтения",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"disabled",description:"Блокировка поля ввода",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"equalsFn",description:"Функция для проверки равенства элементов",type:{name:"(a: unknown, b: unknown) => boolean"},defaultValue:{func:!0,value:"(a: unknown, b: unknown): boolean => a === b"}},{name:"placement",description:`Сторона цели, у которой появится плавающий элемент,
...
`,l.jsx(Je,{})]})}function yl(a={}){const{wrapper:e}={...ge(),...a.components};return e?l.jsx(e,{...a,children:l.jsx(me,{...a})}):me(a)}const bl=Ge({UiMenuItem:Ke,UiMenuItemGroup:Pe,UiPopperConnector:Fe,UiSelectPopper:Be,UiSelectTrigger:Ae}),Fl={title:"Components/UiSelect",component:we,argTypes:{id:{control:!1},value:{control:!1},expanded:{control:"boolean"},clearable:{control:"boolean"},placeholder:{control:"text"},filterable:{control:"boolean"},invalid:{control:"boolean"},placeholderOnly:{control:"boolean"},readonly:{control:"boolean"},disabled:{control:"boolean"},multiple:{control:"boolean"},ticker:{control:"boolean"},textboxSize:{options:Object.values(Ne)},placement:{options:Object.values(X)},popperFitTrigger:{control:"boolean"},popperClass:{control:"text"},popperOptions:{control:!1},targetTriggers:{control:!1},popperTriggers:{control:!1}},render:Le({provider:bl,worker:gl}),parameters:{docs:{page:yl},layout:"centered"}},Z={args:{placeholder:"test123",ticker:!1,disabled:!1,multiple:!1,filterable:!1}},A=K({args:{placeholder:"Исполнитель",ticker:!1,disabled:!1,multiple:!1,filterable:!1}}),B=K({args:{placeholder:"Исполнители",ticker:!1,disabled:!1,multiple:!0,clearable:!0,filterable:!1}}),P=K({args:{placeholder:"Найти пользователя",ticker:!1,disabled:!1,multiple:!1,filterable:!0,clearable:!0}}),F=K({args:{placeholder:"Пользователь",value:"Eduardo Henry",ticker:!1,disabled:!1,multiple:!1,filterable:!1,invalid:!0}}),R=K({args:{placeholder:"Пользователь",value:"Kyle Simmmons",ticker:!1,disabled:!1,readonly:!0,multiple:!1,filterable:!1}}),q=K({args:{placeholder:"Пользователь",value:"Philip Williamson",ticker:!1,disabled:!0,multiple:!1,filterable:!1}});Z.parameters={...Z.parameters,docs:{...Z.parameters?.docs,source:{originalSource:`{
  args: {
    placeholder: 'test123',
    ticker: false,
    disabled: false,
...
})`,...P.parameters?.docs?.source}}};F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`docsOnlyStory({
  args: {
    placeholder: 'Пользователь',
    value: 'Eduardo Henry',
    ticker: false,
...
})`,...q.parameters?.docs?.source}}};const Rl=["Sandbox","BasicSingle","MultipleClearable","FilterableSearch","InvalidState","ReadonlyState","DisabledState"];export{A as BasicSingle,q as DisabledState,P as FilterableSearch,F as InvalidState,B as MultipleClearable,R as ReadonlyState,Z as Sandbox,Rl as __namedExportsOrder,Fl as default};
