import"./uid-B3BrmEQy.js";/* empty css                   */import{h as C,r as m,c as h,m as d,z as i,D as T,A as M,o as f,N as r,t as N,a as p,H as k}from"./iframe-DCDVANl5.js";import{_ as x}from"./UiButton-ChRPCksm.js";import{_ as j,S as v,a as b,D as g}from"./UiModalSidebar-kvVIAzvL.js";import{j as e}from"./jsx-runtime-CUtLY3pZ.js";import{useMDXComponents as y}from"./index-DwIA-ESQ.js";import{T as a}from"./ToReact-CfRlBj5r.js";import"./preload-helper-PPVm8Dsz.js";import"./predicate-ClulhfEu.js";import"./render-Bpb61ZF3.js";import"./composables-ACcgJ6G0.js";import"./UiScrollBox-r3S53o2O.js";import"./UiTooltip-DSxV8PyM.js";import"./UiPopper-BfZHweql.js";import"./UiTransition-DbhvyPuS.js";import"./clear-ByWhi14M.js";import"./index-EpkwYzaG.js";const B={style:{height:"1500px"}},O={key:0,style:{"margin-top":"16px"}},t=C({__name:"UiModalSidebar.example",props:{buttonTitle:{type:String,default:""},hasNesting:{type:Boolean,default:!1},footer:{type:Boolean,default:!1}},setup(o){const n=m(!1),c=m(!1);return(U,s)=>(f(),h("div",null,[d(x,{onClick:s[0]||(s[0]=l=>n.value=!0)},{default:i(()=>[r(N(o.buttonTitle),1)]),_:1}),d(j,M({opened:n.value,"onUpdate:opened":s[6]||(s[6]=l=>n.value=l)},U.$attrs),T({title:i(()=>[s[7]||(s[7]=r(" Заголовок ",-1))]),default:i(()=>[p("div",B,[s[12]||(s[12]=p("div",null,"Контент высотой 1500px",-1)),o.hasNesting?(f(),h("div",O,[d(x,{onClick:s[1]||(s[1]=l=>c.value=!0)},{default:i(()=>[...s[8]||(s[8]=[r(" Вложенная шторка ",-1)])]),_:1}),d(j,{opened:c.value,"onUpdate:opened":s[3]||(s[3]=l=>c.value=l),onCloseSidebar:s[4]||(s[4]=l=>c.value=!1)},{title:i(()=>[...s[9]||(s[9]=[r(" Header ",-1)])]),footer:i(()=>[d(x,{onClick:s[2]||(s[2]=l=>c.value=!1)},{default:i(()=>[...s[10]||(s[10]=[r(" Закрыть ",-1)])]),_:1})]),default:i(()=>[s[11]||(s[11]=p("div",{style:{height:"1500px"}},[p("div",null,"Some content"),p("div",null,"Вложенная шторка")],-1))]),_:1},8,["opened"])])):k("",!0)])]),_:2},[o.footer?{name:"footer",fn:i(()=>[d(x,{onClick:s[5]||(s[5]=l=>n.value=!1)},{default:i(()=>[...s[13]||(s[13]=[r(" Закрыть ",-1)])]),_:1})]),key:"0"}:void 0]),1040,["opened"])]))}});t.__docgenInfo={exportName:"default",displayName:"UiModalSidebar.example",description:"",tags:{},props:[{name:"buttonTitle",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"hasNesting",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"footer",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiModalSidebar.example.vue"]};function S(o){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...y(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"uimodalsidebar",children:"UiModalSidebar"}),`
...
курсора.`]}),`
`,e.jsx(a,{is:t,buttonTitle:"Фиксированная панель (sm)",direction:"left",fixed:!0}),`
...
`]})]})}function I(o={}){const{wrapper:n}={...y(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(S,{...o})}):S(o)}const K={title:"Components/UiModalSidebar",component:j,args:{direction:g.RIGHT,fixed:!1,scrolling:b.NORMAL,size:v.SM},argTypes:{opened:{control:!1},id:{control:!1},direction:{control:"select",options:Object.values(g)},scrolling:{control:"select",options:Object.values(b)},size:{control:"select",options:Object.values(v)}},render:o=>({components:{UiButton:x,UiModalSidebar:j},setup(){return{args:o,opened:m(!1)}},template:`
      <div>
    ...
    `}),parameters:{docs:{page:I},layout:"centered"}},u={};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:"{}",...u.parameters?.docs?.source}}};const Q=["Sandbox"];export{u as Sandbox,Q as __namedExportsOrder,K as default};
