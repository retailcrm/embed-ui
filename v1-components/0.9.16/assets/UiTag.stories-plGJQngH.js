import{_ as a,S as c}from"./UiTag-DnS7ZPCo.js";import{j as e}from"./jsx-runtime-CUtLY3pZ.js";import{useMDXComponents as l}from"./index-DwIA-ESQ.js";import{T as t}from"./ToReact-CfRlBj5r.js";import{h as x,y as m,z as u,L as p,M as g,o as d,c as h,N as j,t as b,F as f,H as k}from"./iframe-DCDVANl5.js";import"./clear-ByWhi14M.js";import"./plugin-DGcvpriV.js";import"./index-BAxMPZdI.js";import"./index-EpkwYzaG.js";import"./preload-helper-PPVm8Dsz.js";const r=x({__name:"UiTag.example",props:{text:{type:String,default:""}},setup(n){return(s,T)=>(d(),m(a,p(g(s.$attrs)),{default:u(()=>[n.text.length?(d(),h(f,{key:0},[j(b(n.text),1)],64)):k("",!0)]),_:1},16))}});r.__docgenInfo={exportName:"default",displayName:"UiTag.example",description:"",tags:{},props:[{name:"text",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiTag.example.vue"]};function o(n){const s={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...l(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.h1,{id:"uitag",children:"UiTag"}),`
...
`})})]})}function v(n={}){const{wrapper:s}={...l(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(o,{...n})}):o(n)}const I={title:"Components/UiTag",component:a,args:{size:c.LG,background:"#66d2b6",saturated:!0},argTypes:{size:{control:"select",options:Object.values(c)},icon:{control:!1},default:{control:!1},"remove-icon":{control:!1}},render:n=>({components:{UiTag:a},setup(){return{args:n}},template:`
    ...
    `}),parameters:{docs:{page:v},layout:"centered"}},i={};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"{}",...i.parameters?.docs?.source}}};const M=["Sandbox"];export{i as Sandbox,M as __namedExportsOrder,I as default};
