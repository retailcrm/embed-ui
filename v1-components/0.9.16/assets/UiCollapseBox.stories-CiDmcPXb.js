...
`,n.jsx($,{})]})}function X(s={}){const{wrapper:e}={...w(),...s.components};return e?n.jsx(e,{...s,children:n.jsx(_,{...s})}):_(s)}const de={title:"Components/UiCollapseBox",component:r,args:{id:"collapse-box-sandbox",expanded:!1,expandable:!0,collapsible:!0,toggleable:!0,collapseBehaviour:I.HIDE,collapseDuration:.75,disabled:!1,color:U.BLUE,iconSize:y.SM,bordered:!1},argTypes:{id:{control:"text"},expanded:{control:!1},collapseBehaviour:{control:"select",options:Object.values(I)},color:{control:"select",options:Object.values(U)},iconSize:{control:"select",options:Object.values(y)}},render:s=>({components:{UiButton:R,UiCollapseBox:r,IconSettingsOutlined:x},setup(){const e=B(s.expanded??!1);return M(()=>s.expanded,l=>{typeof l<"u"&&(e.value=l)}),{expanded:e,props:L(()=>D(s,["expanded"]))}},template:`
...
}`,...b.parameters?.docs?.source}}};const pe=["Sandbox","Expanded","Disabled","Bordered","Group"];export{j as Bordered,h as Disabled,g as Expanded,b as Group,u as Sandbox,pe as __namedExportsOrder,de as default};
