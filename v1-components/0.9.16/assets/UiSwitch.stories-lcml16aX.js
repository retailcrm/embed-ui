...
`,s.jsx(T,{})]})}function ee(l={}){const{wrapper:e}={...$(),...l.components};return e?s.jsx(e,{...l,children:s.jsx(y,{...l})}):y(l)}const je={title:"Components/UiSwitch",component:c,args:{id:"switch-sandbox",value:!1,disabled:!1,square:!1},argTypes:{value:{control:!1}},render:l=>({components:{UiSwitch:c},setup(){const e=j(l.value??!1);return C(()=>l.value,i=>{typeof i<"u"&&(e.value=i)}),{value:e,props:M(()=>D(l,["value"]))}},template:`
...
}`,...m.parameters?.docs?.source}}};const ve=["Sandbox","Checked","Disabled","Square"];export{p as Checked,h as Disabled,u as Sandbox,m as Square,ve as __namedExportsOrder,je as default};
