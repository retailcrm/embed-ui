...
`]})]})}function S(d={}){const{wrapper:n}={...C(),...d.components};return n?e.jsx(n,{...d,children:e.jsx(k,{...d})}):k(d)}const K={title:"Components/UiModalWindow",component:x,args:{appearance:T.POPUP,scrolling:U.NORMAL},argTypes:{id:{control:!1},opened:{control:!1},appearance:{control:"select",options:Object.values(T)},scrolling:{control:"select",options:Object.values(U)},title:{control:!1},default:{control:!1},footer:{control:!1}},render:d=>({components:{UiButton:p,UiModalWindow:x},setup(){return{args:d,open:v(!1)}},template:`
    ...
    `}),decorators:[()=>({template:'<div style="height: 500px"><story /></div>'})],parameters:{docs:{page:S},layout:"centered"}},u={};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:"{}",...u.parameters?.docs?.source}}};const q=["Sandbox"];export{u as Sandbox,q as __namedExportsOrder,K as default};
