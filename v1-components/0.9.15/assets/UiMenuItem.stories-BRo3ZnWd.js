...
`,e.jsx(a,{is:s,size:"sm"})]})}function D(t={}){const{wrapper:n}={...x(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(f,{...t})}):f(t)}const q={id:"UiMenuItem",title:"Components/UiMenuItem",component:c,argTypes:{size:{options:Object.values(p)},counter:{control:{type:"number"}}},render:t=>({components:{UiMenuItem:c},setup:()=>({args:t}),template:`
