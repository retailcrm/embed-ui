import{c as w,a as I,o as p,h as T,r as m,y as B,C as U,z as t,A as k,D as s,m as a,j as N}from"./iframe-7PfFZbMo.js";import{I as f}from"./caret-down-DRceoxRM.js";import{_ as r,S as h,T as j,I as C}from"./UiTextbox-BM0nELoK.js";import{o as b}from"./utils-BqzVSXwn.js";import{j as e}from"./jsx-runtime-oUFsCJCe.js";import{useMDXComponents as g}from"./index-nKJCzsSA.js";import{T as d}from"./ToReact-zb7Edybv.js";import"./preload-helper-PPVm8Dsz.js";import"./composables-DmHLbFXN.js";import"./plugin-mT4wte91.js";import"./index-BAxMPZdI.js";import"./index-a22oIHiu.js";const S={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"};function _(i,n){return p(),w("svg",S,[...n[0]||(n[0]=[I("path",{fill:"currentColor","fill-rule":"evenodd",d:"m16.333 15.072 3.556 3.56a.445.445 0 0 1-.018.613l-.622.623a.445.445 0 0 1-.631 0l-3.556-3.56a2.3 2.3 0 0 1-.266-.32l-.667-.89a6.22 6.22 0 0 1-3.885 1.362A6.232 6.232 0 0 1 7.531 4.613a6.22 6.22 0 0 1 7.572 1.753 6.235 6.235 0 0 1-.04 7.78l.888.614q.209.134.382.312M5.8 10.23c0 2.458 1.99 4.45 4.445 4.45 1.178 0 2.309-.469 3.142-1.303a4.453 4.453 0 0 0-3.142-7.597 4.447 4.447 0 0 0-4.445 4.45","clip-rule":"evenodd"},null,-1)])])}const v={render:_},c=T({__name:"UiTextbox.example",props:{id:{},type:{},value:{default:""},max:{},min:{},step:{},required:{type:Boolean},autocomplete:{},inputmode:{},maxlength:{},decimals:{},size:{},placeholder:{},prefix:{},suffix:{},active:{type:Boolean},autofocus:{type:Boolean},autoselect:{type:Boolean},clearable:{type:Boolean},readonly:{type:Boolean},disabled:{type:Boolean},invalid:{type:Boolean},multiline:{type:Boolean},rows:{},cols:{},outlined:{type:Boolean,default:!0},autofit:{type:Boolean},inputAttributes:{},withLeadingIcon:{type:Boolean,default:!1},withTrailingIcon:{type:Boolean,default:!1}},setup(i){const n=i,o=m(n.value);return(L,x)=>(p(),B(r,k({value:o.value,"onUpdate:value":x[0]||(x[0]=y=>o.value=y)},s(b)(n,["value","withLeadingIcon","withTrailingIcon"])),U({_:2},[i.withLeadingIcon?{name:"leading-icon",fn:t(()=>[a(s(v),{"aria-hidden":"true"})]),key:"0"}:void 0,i.withTrailingIcon?{name:"trailing-icon",fn:t(()=>[a(s(f),{"aria-hidden":"true"})]),key:"1"}:void 0]),1040,["value"]))}});c.__docgenInfo={exportName:"default",displayName:"UiTextbox.example",description:"",tags:{},props:[{name:"value",defaultValue:{func:!1,value:"''"}},{name:"outlined",defaultValue:{func:!1,value:"true"}},{name:"withLeadingIcon",defaultValue:{func:!1,value:"false"}},{name:"withTrailingIcon",defaultValue:{func:!1,value:"false"}}],sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiTextbox.example.vue"]};function u(i){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",ul:"ul",...g(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"uitextbox",children:"UiTextbox"}),`
...
const term = ref('')
<\/script>
`})})]})}function E(i={}){const{wrapper:n}={...g(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(u,{...i})}):u(i)}const Y={title:"Components/UiTextbox",component:r,args:{id:void 0,type:j.TEXT,value:"",placeholder:"Enter text",size:h.SM,prefix:"https://",suffix:"₽",active:!1,invalid:!1,multiline:!1,autofit:!1},argTypes:{id:{control:!1},type:{control:"select",options:Object.values(j)},value:{control:"text"},size:{control:"select",options:Object.values(h)},inputmode:{control:"select",options:Object.values(C)}},render:i=>({components:{IconCaret:f,IconSearch:v,UiTextbox:r},setup(){const{value:n}=i;return{value:m(String(n)),props:N(()=>b(i,["value"]))}},template:`
      <UiTextbox
          v-model:value="value"
          v-bind="props"
      >
    ...
    `}),parameters:{docs:{page:E},layout:"centered"}},l={};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"{}",...l.parameters?.docs?.source}}};const Z=["Sandbox"];export{l as Sandbox,Z as __namedExportsOrder,Y as default};
