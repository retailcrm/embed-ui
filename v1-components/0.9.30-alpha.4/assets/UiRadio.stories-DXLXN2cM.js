...
`,n.jsx(k,{})]})}function S(o={}){const{wrapper:e}={...f(),...o.components};return e?n.jsx(e,{...o,children:n.jsx(j,{...o})}):j(o)}const J={title:"Components/UiRadio",component:m,argTypes:{id:{control:!1},model:{control:!1}},render:o=>({components:{UiRadio:m},setup(){return{model:v(o.model),props:U(()=>N(o,["id","model"]))}},template:`
      <UiRadio
          id="radio"
          v-model:model="model"
          v-bind="props"
    ...
    `}),parameters:{docs:{page:S},layout:"centered"}},r={args:{value:"radio"}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    value: 'radio'
  }
