import{j as e}from"./jsx-runtime-BGuG-3rP.js";import{useMDXComponents as t}from"./index-Du9med4y.js";import"./iframe-BHh6c9lZ.js";import"./preload-helper-PPVm8Dsz.js";function d(r){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"функции-форматирования-даты-и-времени",children:"Функции форматирования даты и времени"}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import { formatDate } from '@retailcrm/embed-ui-v1-components/remote'
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import { formatDateTime } from '@retailcrm/embed-ui-v1-components/remote'

formatDateTime(new Date('2024-01-22'), 'en-GB') // "22/01/24 15:30"
formatDateTime(new Date('2024-01-22'), 'es-ES') // "22.01.24 15:30"
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import { formatTime } from '@retailcrm/embed-ui-v1-components/remote'
...
`})})]})}function l(r={}){const{wrapper:n}={...t(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(d,{...r})}):d(r)}export{l as default};
