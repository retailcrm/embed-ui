...
`})})]})}function A(a={}){const{wrapper:t}={...h(),...a.components};return t?e.jsx(t,{...a,children:e.jsx(u,{...a})}):u(a)}const R={title:"Components/UiButton",component:i,args:{appearance:l.PRIMARY,size:d.SM,variant:o.DEFAULT},argTypes:{href:{control:"text"},appearance:{control:"select",options:Object.values(l)},size:{control:"select",options:Object.values(d)},variant:{control:"select",options:Object.values(o)}},render:a=>({components:{IconAdd:m,UiButton:i},setup(){return{args:a}},template:`
    ...
    `}),parameters:{docs:{page:A},layout:"centered"}},r={};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"{}",...r.parameters?.docs?.source}}};const O=["Sandbox"];export{r as Sandbox,O as __namedExportsOrder,R as default};
