import{h as u,r as t,j as d,c as m,m as x,a as h,D as p,o as v,x as j,G as E}from"./iframe-CzYs1BjE.js";import{_ as i,S as _}from"./UiDatePicker-COrGS_nx.js";import{T,A as U}from"./UiCalendar-BvEEc-G3.js";import{o as z}from"./utils-BqzVSXwn.js";import{j as n}from"./jsx-runtime-CLYr9vDv.js";import{useMDXComponents as O}from"./index-DXIs0Z_P.js";import{A as $}from"./blocks-BSwO8k7m.js";import{T as c}from"./ToReact-C01x9xsS.js";import"./preload-helper-PPVm8Dsz.js";import"./UiButton-B6P_OpkA.js";import"./predicate-ClulhfEu.js";import"./composables-DIK_niTW.js";import"./UiPopper-FDzTy8d3.js";import"./UiTextbox-BGqfWgVD.js";import"./plugin-4DvlS7Sf.js";import"./index-BAxMPZdI.js";import"./UiMenuItem-QstNIx_H.js";import"./UiScrollBox-B2TZR1_b.js";import"./ru-WeKkgns0.js";import"./chevron-right-CRTpoOdW.js";import"./index-BTaHYB_U.js";const q={style:{display:"inline-block"}},F={style:{"margin-top":"8px","font-size":"12px",color:"#666"}},N=u({__name:"UiDatePicker.basic.example",setup(o){const e=t(new Date("2024-11-21T00:00:00")),r=d(()=>e.value?e.value.toISOString():"null");return(a,l)=>(v(),m("div",q,[x(i,{value:e.value,"onUpdate:value":l[0]||(l[0]=s=>e.value=s),placeholder:"Select date"},null,8,["value"]),h("div",F," Selected: "+p(r.value),1)]))}});N.__docgenInfo={exportName:"default",displayName:"UiDatePicker.basic.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiDatePicker.basic.example.vue"]};const M={style:{display:"inline-block"}},Y={style:{"margin-top":"8px","font-size":"12px",color:"#666"}},P=u({__name:"UiDatePicker.bounds.example",setup(o){const e=new Date("2024-11-05T00:00:00"),r=new Date("2024-11-25T00:00:00"),a=t(new Date("2024-11-14T00:00:00"));return(l,s)=>(v(),m("div",M,[x(i,{value:a.value,"onUpdate:value":s[0]||(s[0]=w=>a.value=w),"min-date":j(e),"max-date":j(r),placeholder:"Choose date in available range"},null,8,["value","min-date","max-date"]),h("div",Y," Allowed: "+p(j(e).toISOString())+" - "+p(j(r).toISOString()),1)]))}});P.__docgenInfo={exportName:"default",displayName:"UiDatePicker.bounds.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiDatePicker.bounds.example.vue"]};const B={style:{display:"inline-block"}},G={style:{"margin-top":"8px","font-size":"12px",color:"#666"}},I=u({__name:"UiDatePicker.confirmed.example",setup(o){const e=t(null),r=d(()=>e.value?e.value.toISOString():"null");return(a,l)=>(v(),m("div",B,[x(i,{value:e.value,"onUpdate:value":l[0]||(l[0]=s=>e.value=s),synchronization:"confirmed",placeholder:"Select date and confirm"},null,8,["value"]),h("div",G," Applied: "+p(r.value),1)]))}});I.__docgenInfo={exportName:"default",displayName:"UiDatePicker.confirmed.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiDatePicker.confirmed.example.vue"]};const L={style:{display:"inline-block"}},A=u({__name:"UiDatePicker.locale.example",setup(o){const e=t(new Date("2024-11-21T00:00:00"));return(r,a)=>(v(),m("div",L,[x(i,{value:e.value,"onUpdate:value":a[0]||(a[0]=l=>e.value=l),locale:"ru-RU","first-day-of-week":1,placeholder:"Выберите дату"},null,8,["value"]),a[1]||(a[1]=h("div",{style:{"margin-top":"8px","font-size":"12px",color:"#666"}}," Локаль: ru-RU, firstDayOfWeek: 1 ",-1))]))}});A.__docgenInfo={exportName:"default",displayName:"UiDatePicker.locale.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiDatePicker.locale.example.vue"]};const W={style:{display:"inline-block"}},H={style:{"margin-top":"8px","font-size":"12px",color:"#666"}},C=u({__name:"UiDatePicker.quick-options.example",setup(o){const e=t(new Date("2024-11-21T00:00:00")),r=[{label:"Today",value:new Date("2024-11-21T00:00:00")},{label:"Yesterday",value:new Date("2024-11-20T00:00:00")},{label:"This week",value:[new Date("2024-11-18T00:00:00"),new Date("2024-11-24T00:00:00")]}],a=d(()=>e.value?Array.isArray(e.value)?e.value.map(l=>l.toISOString()).join(" - "):e.value.toISOString():"null");return(l,s)=>(v(),m("div",W,[x(i,{value:e.value,"onUpdate:value":s[0]||(s[0]=w=>e.value=w),synchronization:"confirmed","quick-options":r,placeholder:"Use quick options"},null,8,["value"]),h("div",H," Applied: "+p(a.value),1)]))}});C.__docgenInfo={exportName:"default",displayName:"UiDatePicker.quick-options.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiDatePicker.quick-options.example.vue"]};const V={style:{display:"grid",gap:"8px"}},X={style:{"font-size":"12px",color:"#666"}},R=u({__name:"UiDatePicker.range.example",setup(o){const e=t([new Date("2024-11-10T00:00:00"),new Date("2024-11-19T00:00:00")]),r=d(()=>!e.value||e.value.length===0?"null":e.value.map(a=>a.toISOString()).join(" - "));return(a,l)=>(v(),m("div",V,[x(i,{value:e.value,"onUpdate:value":l[0]||(l[0]=s=>e.value=s),type:"range",placeholder:"Select period"},null,8,["value"]),h("div",X," Selected: "+p(r.value),1)]))}});R.__docgenInfo={exportName:"default",displayName:"UiDatePicker.range.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiDatePicker.range.example.vue"]};function S(o){const e={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...O(),...o.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"uidatepicker",children:"UiDatePicker"}),`
...
}`,...b.parameters?.docs?.source}}};const ke=["Sandbox","Range","Confirmed","QuickOptions","Bounds","RussianLocale"];export{f as Bounds,k as Confirmed,y as QuickOptions,g as Range,b as RussianLocale,D as Sandbox,ke as __namedExportsOrder,ge as default};
