import{_ as i}from"./UiScrollBox-849KBg-c.js";import{j as s}from"./jsx-runtime-N83kn9-W.js";import{useMDXComponents as _}from"./index-g1djAheZ.js";import{T as t}from"./ToReact-BEI8S_zj.js";import{d as f,o as y,c as b,v as l,g as a,a as d,x as c,m as p}from"./vue.esm-bundler-BDTEftJR.js";import{_ as g}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Dj9yGJcI.js";import"./preview-DbwDgyJs.js";const j=f({__name:"UiScrollBox.example",setup(o){return(e,C)=>(y(),b("div",{class:c(e.$style.wrapper)},[l(i,p(e.$attrs,{class:e.$style.block}),{default:a(()=>[d("div",{class:c([e.$style.content,e.$style.content_tall])},null,2)]),_:1},16,["class"]),l(i,p(e.$attrs,{class:e.$style.block}),{default:a(()=>[d("div",{class:c([e.$style.content,e.$style.content_wide])},null,2)]),_:1},16,["class"])],2))}}),w="_wrapper_6iu54_1",B="_block_6iu54_4",S="_content_6iu54_13",$="_content_wide_6iu54_17",k="_content_tall_6iu54_20",q={wrapper:w,block:B,content:S,content_wide:$,content_tall:k},v={$style:q},n=g(j,[["__cssModules",v]]);j.__docgenInfo={exportName:"default",displayName:"UiScrollBox.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiScrollBox.example.vue"]};function u(o){const e={code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",..._(),...o.components};return s.jsxs(s.Fragment,{children:[s.jsx(e.h1,{id:"uiscrollbox",children:"UiScrollBox"}),`
...
`,s.jsxs(e.p,{children:["Для размещения контента используется слот по-умолчанию ",s.jsx(e.code,{children:"default"}),"."]})]})}function U(o={}){const{wrapper:e}={..._(),...o.components};return e?s.jsx(e,{...o,children:s.jsx(u,{...o})}):u(o)}const X={title:"Components/UiScrollBox",component:i,argTypes:{default:{control:!1}},render:o=>({components:{UiScrollBox:i},setup(){return{args:o}},data:()=>({styles:{height:"250px",width:"300px",padding:"0px 16px 16px",border:"1px solid rgba(30, 34, 72, 0.16)",borderRadius:"4px"}}),template:`
    ...
    `}),parameters:{docs:{page:U},layout:"centered"}},r={};var m,x,h;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:"{}",...(h=(x=r.parameters)==null?void 0:x.docs)==null?void 0:h.source}}};const F=["Sandbox"];export{r as Sandbox,F as __namedExportsOrder,X as default};
