...
`})})]})}function N(a={}){const{wrapper:t}={...g(),...a.components};return t?e.jsx(t,{...a,children:e.jsx(u,{...a})}):u(a)}const V={title:"Components/UiButton",component:i,args:{appearance:o.PRIMARY,size:d.SM,variant:l.DEFAULT},argTypes:{href:{control:"text"},appearance:{control:"select",options:Object.values(o)},size:{control:"select",options:Object.values(d)},variant:{control:"select",options:Object.values(l)}},render:a=>({components:{IconAdd:f,UiButton:i},setup(){return{args:a}},template:`
    ...
    `}),parameters:{docs:{page:N},layout:"centered"}},r={};var h,m,j;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:"{}",...(j=(m=r.parameters)==null?void 0:m.docs)==null?void 0:j.source}}};const F=["Sandbox"];export{r as Sandbox,F as __namedExportsOrder,V as default};
