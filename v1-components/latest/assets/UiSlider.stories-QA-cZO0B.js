import{h as U,c as t,k as N,a as i,D as u,E as s,r as v,o as c,w as A,O as w,q as R}from"./iframe-DDyl2AmK.js";import{_ as p,T as o}from"./UiSlider-BrjJ0zPm.js";import{o as T}from"./utils-BqzVSXwn.js";import{u as E,j as n}from"./index-DC6AVhol.js";import{A as G}from"./blocks-irvO_Kf_.js";import{T as m}from"./ToReact-C7vZiqYZ.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CDnKqZOh.js";const L={style:{display:"grid",gap:"12px",width:"320px"}},f=U({__name:"UiSlider.single.example",setup(r){const e=v(20);return(d,l)=>(c(),t("div",L,[N(p,{value:e.value,"onUpdate:value":l[0]||(l[0]=a=>e.value=a)},null,8,["value"]),i("div",null,[l[1]||(l[1]=i("strong",null,"Value:",-1)),u(" "+s(e.value),1)])]))}});f.__docgenInfo=Object.assign({displayName:f.name??f.__name},{exportName:"default",displayName:"UiSlider.single.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiSlider.single.example.vue"]});const V={style:{display:"grid",gap:"12px",width:"320px"}},_=U({__name:"UiSlider.range.example",setup(r){const e=v([20,80]);return(d,l)=>(c(),t("div",V,[N(p,{value:e.value,"onUpdate:value":l[0]||(l[0]=a=>e.value=a),type:"range"},null,8,["value"]),i("div",null,[l[1]||(l[1]=i("strong",null,"Value:",-1)),u(" ["+s(e.value[0])+", "+s(e.value[1])+"]",1)])]))}});_.__docgenInfo=Object.assign({displayName:_.name??_.__name},{exportName:"default",displayName:"UiSlider.range.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiSlider.range.example.vue"]});const $={style:{display:"grid",gap:"12px",width:"320px"}},D={key:0},I={key:1},x=U({__name:"UiSlider.labelled.example",props:{range:{type:Boolean,default:!1}},setup(r){const e=v([20,80]);return(d,l)=>(c(),t("div",$,[N(p,{value:e.value,"onUpdate:value":l[0]||(l[0]=a=>e.value=a),type:r.range?"range":"single",min:0,max:100,labelled:""},{label:A(({boundary:a})=>[u(s(a)+"% ",1)]),handle:A(({boundary:a})=>[u(s(a)+"% ",1)]),_:1},8,["value","type"]),i("div",null,[l[1]||(l[1]=i("strong",null,"Value:",-1)),Array.isArray(e.value)?(c(),t("span",D,"["+s(e.value[0])+", "+s(e.value[1])+"]",1)):(c(),t("span",I,s(e.value),1))])]))}});x.__docgenInfo=Object.assign({displayName:x.name??x.__name},{exportName:"default",displayName:"UiSlider.labelled.example",description:"",tags:{},props:[{name:"range",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiSlider.labelled.example.vue"]});const O={style:{display:"grid",gap:"12px",width:"320px"}},S=U({__name:"UiSlider.bounds.example",setup(r){const e=v([0,80]);return(d,l)=>(c(),t("div",O,[N(p,{value:e.value,"onUpdate:value":l[0]||(l[0]=a=>e.value=a),type:"range",min:10,max:60},null,8,["value"]),l[2]||(l[2]=i("div",null,[i("strong",null,"Min/Max:"),u(" 10 / 60")],-1)),i("div",null,[l[1]||(l[1]=i("strong",null,"Value:",-1)),u(" ["+s(e.value[0])+", "+s(e.value[1])+"]",1)])]))}});S.__docgenInfo=Object.assign({displayName:S.name??S.__name},{exportName:"default",displayName:"UiSlider.bounds.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiSlider.bounds.example.vue"]});function k(r){const e={code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...E(),...r.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"uislider",children:"UiSlider"}),`
...
`,n.jsx(G,{})]})}function P(r={}){const{wrapper:e}={...E(),...r.components};return e?n.jsx(e,{...r,children:n.jsx(k,{...r})}):k(r)}const K={title:"Components/UiSlider",component:p,args:{value:20,type:o.SINGLE,min:0,max:100,labelled:!1},argTypes:{value:{control:!1},type:{control:"select",options:Object.values(o)},min:{control:"number"},max:{control:"number"},labelled:{control:"boolean"},label:{control:!1},handle:{control:!1}},render:r=>({components:{UiSlider:p},setup(){const e=v(r.value??20);return w(()=>r.type,d=>{d===o.RANGE&&!Array.isArray(e.value)&&(e.value=[r.min??0,r.max??100]),d===o.SINGLE&&Array.isArray(e.value)&&(e.value=e.value[0]??r.min??0)},{immediate:!0}),w(()=>r.value,d=>{typeof d<"u"&&(e.value=d)}),{value:e,props:R(()=>T(r,["value"]))}},template:`
    ...
    `}),parameters:{docs:{page:P},layout:"centered"}},h={},j={args:{type:o.RANGE,value:[20,80]}},g={args:{labelled:!0}},b={args:{labelled:!0,type:o.RANGE,value:[25,65]}},y={args:{type:o.RANGE,min:10,max:60,value:[0,80]}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:"{}",...h.parameters?.docs?.source}}};j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  args: {
    type: TYPE.RANGE,
    value: [20, 80]
  }
...
}`,...y.parameters?.docs?.source}}};const z=["Sandbox","Range","Labelled","LabelledRange","BoundedRange"];export{y as BoundedRange,g as Labelled,b as LabelledRange,j as Range,h as Sandbox,z as __namedExportsOrder,K as default};
