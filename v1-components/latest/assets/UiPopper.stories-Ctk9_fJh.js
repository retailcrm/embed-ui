import{_ as a}from"./UiButton-ChRPCksm.js";import{_ as t}from"./UiPopper-BfZHweql.js";import{_ as c}from"./UiPopperConnector-mjhANbIe.js";import{_ as s}from"./UiPopperTarget-BbacPnxs.js";import{j as e}from"./jsx-runtime-CUtLY3pZ.js";import{useMDXComponents as i}from"./index-DwIA-ESQ.js";import{A as d}from"./blocks-Cr0w7RcH.js";import"./iframe-DCDVANl5.js";import"./preload-helper-PPVm8Dsz.js";import"./predicate-ClulhfEu.js";import"./render-Bpb61ZF3.js";import"./composables-ACcgJ6G0.js";import"./index-EpkwYzaG.js";function p(o){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...i(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"uipopper",children:"UiPopper"}),`
...
`,e.jsx(d,{})]})}function l(o={}){const{wrapper:n}={...i(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(p,{...o})}):p(o)}const B={title:"Components/UiPopper",component:t,args:{visible:!1,targetTriggers:["click"],popperTriggers:[],globalTriggers:["miss-click"],placement:"bottom"},argTypes:{target:{table:{disable:!0}},placement:{control:"select",options:["top","right","bottom","left"].reduce((o,n)=>o.concat([n,`${n}-start`,`${n}-end`]),[])}},render:o=>({components:{UiButton:a,UiPopper:t,UiPopperConnector:c,UiPopperTarget:s},setup(){return{args:o}},template:`
      <div class="mb-4">
          <UiPopperConnector>
              <UiButton>
                  I have a popper
    ...
    `}),parameters:{docs:{page:l},layout:"centered"}},r={};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"{}",...r.parameters?.docs?.source}}};const T=["Sandbox"];export{r as Sandbox,T as __namedExportsOrder,B as default};
