...
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-ts",children:`import { UiSlider } from '@retailcrm/embed-ui-v1-components/host'
`})}),`
...
`,n.jsx(G,{})]})}function P(r={}){const{wrapper:e}={...A(),...r.components};return e?n.jsx(e,{...r,children:n.jsx(N,{...r})}):N(r)}const z={title:"Components/UiSlider",component:p,args:{value:20,type:o.SINGLE,min:0,max:100,labelled:!1},argTypes:{value:{control:!1},type:{control:"select",options:Object.values(o)},min:{control:"number"},max:{control:"number"},labelled:{control:"boolean"},label:{control:!1},handle:{control:!1}},render:r=>({components:{UiSlider:p},setup(){const e=x(r.value??20);return U(()=>r.type,d=>{d===o.RANGE&&!Array.isArray(e.value)&&(e.value=[r.min??0,r.max??100]),d===o.SINGLE&&Array.isArray(e.value)&&(e.value=e.value[0]??r.min??0)},{immediate:!0}),U(()=>r.value,d=>{typeof d<"u"&&(e.value=d)}),{value:e,props:R(()=>T(r,["value"]))}},template:`
    ...
    `}),parameters:{docs:{page:P},layout:"centered"}},h={},v={args:{type:o.RANGE,value:[20,80]}},j={args:{labelled:!0}},g={args:{labelled:!0,type:o.RANGE,value:[25,65]}},b={args:{type:o.RANGE,min:10,max:60,value:[0,80]}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:"{}",...h.parameters?.docs?.source}}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    type: TYPE.RANGE,
    value: [20, 80]
  }
...
}`,...b.parameters?.docs?.source}}};const J=["Sandbox","Range","Labelled","LabelledRange","BoundedRange"];export{b as BoundedRange,j as Labelled,g as LabelledRange,v as Range,h as Sandbox,J as __namedExportsOrder,z as default};
