import{h as ye}from"./host-lMKwUZTy.js";import{_ as we}from"./UiAvatar-DKZOBRi4.js";import{_ as ve}from"./UiCheckbox-Blzf5zh4.js";import{_ as je}from"./UiLink-dFjgKDl6.js";import{V as W,A as O,_ as Te,a as Ue,b as Ce,c as ke,d as Se,e as _e,f as Re,g as Be,h as Ae}from"./UiTableSorter-BPqld4-d.js";import{_ as Ne}from"./UiTag-m9hWoeCo.js";import{h as te,a4 as oe,a1 as Ge,a0 as Ee,F as Fe,r as Ve,j as Me,G as Ie,U as s,P as $e}from"./iframe-D_giepNj.js";import{d as f,c as ae}from"./createRemoteStoryRender-CMsaxz9-.js";import{d as y}from"./docsOnlyStory-D04fiwRX.js";import{j as n}from"./jsx-runtime-EB8vuoXy.js";import{useMDXComponents as le}from"./index-B4h7UWpK.js";import{e as _,A as Le}from"./blocks-D_HfumAb.js";import"./UiImage-BjzY4tst.js";import"./predicate-ClulhfEu.js";import"./done-S1JclIHU.js";import"./utils-BqzVSXwn.js";import"./composables-pR5k2Fon.js";import"./clear-DZAGSHcA.js";import"./plugin-CfrNpzbY.js";import"./index-BAxMPZdI.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CjlJ4NSM.js";const re=te({name:"UiTableColumn",props:{label:{type:String,default:""},width:{type:[String,Number],default:void 0},minWidth:{type:[String,Number],default:void 0},maxWidth:{type:[String,Number],default:void 0},align:{type:String,default:O.LEFT,validator:t=>Object.values(O).includes(t)},valign:{type:String,default:W.MIDDLE,validator:t=>Object.values(W).includes(t)},trim:{type:Boolean,default:!1},colspan:{type:Function,default:void 0},rowspan:{type:Function,default:void 0}},setup(){return()=>null}});re.__docgenInfo={displayName:"UiTableColumn",exportName:"default",description:"",tags:{},props:[{name:"label",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"width",type:{name:"string|number"},defaultValue:{func:!1,value:"undefined"}},{name:"minWidth",type:{name:"string|number"},defaultValue:{func:!1,value:"undefined"}},{name:"maxWidth",type:{name:"string|number"},defaultValue:{func:!1,value:"undefined"}},{name:"align",type:{name:"ALIGN | `${ALIGN}`"},defaultValue:{func:!1,value:"ALIGN.LEFT"}},{name:"valign",type:{name:"VALIGN | `${VALIGN}`"},defaultValue:{func:!1,value:"VALIGN.MIDDLE"}},{name:"trim",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"colspan",type:{name:"(row: unknown, index: number) => number | undefined"},defaultValue:{func:!1,value:"undefined"}},{name:"rowspan",type:{name:"(row: unknown, index: number) => number | undefined"},defaultValue:{func:!1,value:"undefined"}}],sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/src/remote/components/table/UiTableColumn.vue"]};const We="UiTableRoot",Oe=f(We),De="UiTableSection",V=f(De),Ke="UiTableRow",x=f(Ke,["click"]),ze="UiTableCol",He=f(ze),Pe="UiTableFooterSection";f(Pe);const Xe="UiTableFooterButton";f(Xe,["click"]);const qe="UiTableHeadCell",se=f(qe),Je="UiTableBodyCell",g=f(Je),Qe="UiTableSorter";f(Qe,["click"]);const H=(t,e)=>typeof t.type!="object"||t.type===null?!1:"name"in t.type&&t.type.name===e,Ye=t=>t.type===re||H(t,"UiTableColumn"),X=t=>t.trim().length===0,D=t=>{const e=[];return t.forEach(a=>{if(Array.isArray(a)){e.push(...D(a));return}if(typeof a=="string"){X(a)||e.push(a);return}if(typeof a=="number"){e.push(a);return}if(oe(a)&&a.type!==Ge){if(a.type===Ee){const r=typeof a.children=="string"?a.children:"";X(r)||e.push(r);return}if(a.type===Fe&&Array.isArray(a.children)){e.push(...D(a.children));return}e.push(a)}}),e},Ze=t=>t===""||t===!0,en=t=>typeof t=="string"?t:"",nn=t=>Object.values(O).includes(t)?t:O.LEFT,tn=t=>Object.values(W).includes(t)?t:W.MIDDLE,on=t=>{const e=t.children;if(!e||Array.isArray(e)||typeof e=="string")return{};const a=e;return{defaultSlot:a.default,cellSlot:a.cell,labelSlot:a.label}},q=t=>typeof t=="function"?t:()=>{},an=t=>D(t).filter(e=>oe(e)).filter(Ye).map((e,a)=>{const r=e.props??{},c=on(e);return{id:String(e.key??`ui-v1-table-column-${a}`),label:en(r.label),width:r.width,minWidth:r.minWidth??r["min-width"],maxWidth:r.maxWidth??r["max-width"],align:nn(r.align),valign:tn(r.valign),trim:Ze(r.trim),getColspan:q(r.colspan),getRowspan:q(r.rowspan),cellSlot:c.cellSlot,defaultSlot:c.defaultSlot,labelSlot:c.labelSlot}}),J=t=>{if(typeof t>"u")return;const e=Math.trunc(Number(t));if(!(!Number.isFinite(e)||e<1))return e},ln=t=>t.labelSlot?.({column:t})??[t.label],rn=(t,e)=>t.cellSlot?.(e)??t.defaultSlot?.(e)??[],Q=t=>{const e=Array.from({length:t.columns.length},()=>0);return t.rows.map((a,r)=>{const c=t.resolveKey(a,r),j=t.expandedKeys.has(c),p=()=>t.toggle(c),E=t.resolveRowAttrs(a,r),w=[];let F=0;return t.columns.forEach((T,U)=>{if(F>0){F-=1;return}if(e[U]>0){e[U]-=1;return}const K={row:a,index:r,key:c,expanded:j,toggle:p,column:T},C=J(T.getColspan(a,r)),k=J(T.getRowspan(a,r)),b=C&&C>1?C:void 0,S=k&&k>1?k:void 0;if(b&&(F=b-1),S)for(let v=0;v<(b??1);v++)e[U+v]=Math.max(e[U+v]??0,S-1);w.push({column:T,colspan:b,rowspan:S,slotProps:K})}),{row:a,index:r,key:c,attrs:E,expanded:j,toggle:p,cells:w,className:[t.resolveRowClass(a,r),E.class,t.extraClass]}})},sn=t=>typeof t=="string"||typeof t=="number"?!1:t.type===g||t.type===se||H(t,"UiTableBodyCell")||H(t,"UiTableHeadCell")||t.type==="td"||t.type==="th",Y=t=>{const e=D(t);return e.length===0?!0:!e.every(sn)},dn=(t,e)=>t?.(e)??[String(e.group.key)],cn=(t,e)=>t?.(e)??[],Z=(t,e,a)=>typeof t=="function"?t(e,a):t,ee=(t,e,a)=>t?.(e,a)??{},z=(t,e,a)=>{if(typeof t=="function")return t(e,a);if(typeof t<"u"&&typeof e=="object"&&e!==null&&t in e){const r=e[t];if(typeof r=="string"||typeof r=="number")return r}return a},un=t=>{const e={...t};return delete e.class,e},ie=te({name:"UiTable",inheritAttrs:!1,props:{rows:{type:Array,default:()=>[]},rowKey:{type:[String,Number,Function],default:void 0},headless:{type:Boolean,default:!1},bordered:{type:Boolean,default:!1},fixed:{type:Boolean,default:!1},rowClass:{type:[String,Array,Object,Function],default:void 0},rowAttrs:{type:Function,default:void 0},groupBy:{type:Function,default:void 0},groupHeadClass:{type:[String,Array,Object],default:void 0},groupBodyClass:{type:[String,Array,Object],default:void 0}},emits:{"row:click":(t,e)=>!0},setup(t,{attrs:e,emit:a,expose:r,slots:c}){const j=$e(),p=Ve([]),E=Me(()=>!!(j?.vnode.props?.onRowClick||j?.vnode.props?.["onRow:click"])),w=o=>{p.value=p.value.includes(o)?p.value.filter(l=>l!==o):[...p.value,o]};r({resetExpanded:()=>{p.value=[]},expand:o=>{p.value.includes(o)||(p.value=[...p.value,o])},collapse:o=>{p.value=p.value.filter(l=>l!==o)},toggle:w}),Ie([()=>t.rows,()=>t.rowKey],()=>{const o=new Set(t.rows.map((i,u)=>z(t.rowKey,i,u))),l=p.value.filter(i=>o.has(i));l.length!==p.value.length&&(p.value=l)},{deep:!1});const K=()=>an(c.default?.()??[]),C=()=>t.groupBy?t.groupBy(t.rows):[],k=(o,l)=>({columnsCount:o.length,rowsCount:t.rows.length,groupsCount:l.length,groups:l}),b=()=>["footer-summary","footer-page-size","footer-export","footer-pagination"].some(o=>!!c[o]),S=()=>!!c.footer||b(),v=o=>Math.max(o.length,1),ce=o=>Q({columns:o,rows:t.rows,expandedKeys:new Set(p.value),resolveKey:(l,i)=>z(t.rowKey,l,i),resolveRowAttrs:(l,i)=>ee(t.rowAttrs,l,i),resolveRowClass:(l,i)=>Z(t.rowClass,l,i),toggle:w}),ue=(o,l)=>l.map(i=>({group:i,rows:Q({columns:o,rows:i.rows,expandedKeys:new Set(p.value),extraClass:t.groupBodyClass,resolveKey:(u,d)=>z(t.rowKey,u,d),resolveRowAttrs:(u,d)=>ee(t.rowAttrs,u,d),resolveRowClass:(u,d)=>Z(t.rowClass,u,d),toggle:w})})),pe=(o,l)=>{a("row:click",o,l)},P=(o,l,i="row")=>{const u=`${String(o.key)}:${i}`;return[s(x,{key:u,interactive:E.value,expanded:o.expanded,...un(o.attrs),class:o.className,onClick:d=>pe({row:o.row,index:o.index,key:o.key,expanded:o.expanded,toggle:o.toggle},d)},()=>o.cells.map((d,h)=>s(g,{key:`${u}:cell:${d.column.id}:${h}`,align:d.column.align,valign:d.column.valign,colspan:d.colspan,rowspan:d.rowspan,trim:d.column.trim},()=>rn(d.column,d.slotProps)))),c.expand&&o.expanded?s(x,{key:`${u}:expand`,expanded:!0},()=>s(g,{colspan:l},()=>cn(c.expand,{row:o.row,index:o.index,key:o.key}))):null]},me=(o,l,i)=>{const u=dn(c["group-head"],{group:o,index:l});return s(x,{key:`${String(o.key)}:group-head`,class:t.groupHeadClass},()=>Y(u)?s(g,{colspan:i,theme:"group"},()=>s("div",{class:"ui-v1-table__group-head"},u)):u)},fe=o=>s(x,{key:"empty"},()=>s(g,{colspan:o},()=>s("div",{class:"ui-v1-table__empty"},c.empty?.()??[]))),be=(o,l)=>{if(!S())return null;if(b()){const u=c["footer-summary"]?.(o),d=c["footer-page-size"]?.(o),h=c["footer-export"]?.(o),m=c["footer-pagination"]?.(o);return s(V,{kind:"foot",key:"footer"},()=>s(x,()=>s(g,{colspan:l,class:"ui-v1-table__footer-cell"},()=>s("div",{class:"ui-v1-table__footer"},[u?s("div",{class:"ui-v1-table__footer-meta"},[u]):null,d||h||m?s("div",{class:"ui-v1-table__footer-controls"},[d||h?s("div",{class:"ui-v1-table__footer-main"},[d,h]):null,m?s("div",{class:"ui-v1-table__footer-side"},[m]):null]):null]))))}const i=c.footer?.(o)??[];return s(V,{kind:"foot",key:"footer"},()=>s(x,()=>Y(i)?s(g,{colspan:l},()=>i):i))};return()=>s(Oe,{...e,bordered:t.bordered,fixed:t.fixed},()=>[(()=>{const o=K(),l=v(o),i=C(),u=k(o,i),d=ce(o),h=ue(o,i);return[o.length>0?s("colgroup",{key:"colgroup"},o.map(m=>s(He,{key:`col:${m.id}`,width:m.width,minWidth:m.minWidth,maxWidth:m.maxWidth}))):null,!t.headless&&o.length>0?s(V,{key:"head",kind:"head"},()=>s(x,()=>o.map(m=>s(se,{key:`head:${m.id}`,align:m.align,trim:m.trim},()=>ln(m))))):null,s(V,{key:"body",kind:"body"},()=>t.rows.length===0?fe(l):t.groupBy?h.flatMap(({group:m,rows:he},xe)=>[me(m,xe,l),...he.flatMap(ge=>P(ge,l,`${String(m.key)}:row`))]):d.flatMap(m=>P(m,l))),be(u,l)]})()])}});ie.__docgenInfo={displayName:"UiTable",exportName:"default",description:"",tags:{},props:[{name:"rows",type:{name:"readonly unknown[]"},defaultValue:{func:!0,value:"() => []"}},{name:"rowKey",type:{name:"string | number | RowKeyGetter<unknown>"},defaultValue:{func:!1,value:"undefined"}},{name:"headless",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"bordered",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"fixed",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"rowClass",type:{name:"CssClass | RowClassGetter<unknown>"},defaultValue:{func:!1,value:"undefined"}},{name:"rowAttrs",type:{name:"RowAttrsGetter<unknown>"},defaultValue:{func:!1,value:"undefined"}},{name:"groupBy",type:{name:"GroupBy<unknown, unknown>"},defaultValue:{func:!1,value:"undefined"}},{name:"groupHeadClass",type:{name:"CssClass"},defaultValue:{func:!1,value:"undefined"}},{name:"groupBodyClass",type:{name:"CssClass"},defaultValue:{func:!1,value:"undefined"}}],events:[{name:"row:click"}],sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/src/remote/components/table/UiTable.vue"]};function pn(t){return new Worker(""+new URL("UiTable.reference.remote-B-49c2KI.js",import.meta.url).href,{name:t?.name})}function mn(t){return new Worker(""+new URL("UiTable.remote-DWb-KBGT.js",import.meta.url).href,{name:t?.name})}function ne(t){const e={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...le(),...t.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"uitable",children:"UiTable"}),`
