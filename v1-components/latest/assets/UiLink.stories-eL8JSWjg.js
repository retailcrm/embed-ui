import{_ as l,S as c,A as a}from"./UiLink-CoMUE26l.js";import{j as e}from"./jsx-runtime-BGuG-3rP.js";import{useMDXComponents as x}from"./index-Du9med4y.js";import{T as t}from"./ToReact-BlJIV0T_.js";import{h,s as p,w as j,A as m,B as u,o as d,c as g,C as f,D as k,F as y,y as b}from"./iframe-BHh6c9lZ.js";import"./predicate-ClulhfEu.js";import"./composables-k7d08RWy.js";import"./index-LVSkv26z.js";import"./preload-helper-PPVm8Dsz.js";const n=h({__name:"UiLink.example",props:{text:{type:String,default:""}},setup(i){return(s,_)=>(d(),p(l,m(u(s.$attrs)),{default:j(()=>[i.text.length?(d(),g(y,{key:0},[f(k(i.text),1)],64)):b("",!0)]),_:1},16))}});n.__docgenInfo={exportName:"default",displayName:"UiLink.example",description:"",tags:{},props:[{name:"text",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiLink.example.vue"]};function o(i){const s={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...x(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.h1,{id:"uilink",children:"UiLink"}),`
...
`]})]})}function v(i={}){const{wrapper:s}={...x(),...i.components};return s?e.jsx(s,{...i,children:e.jsx(o,{...i})}):o(i)}const B={title:"Components/UiLink",component:l,args:{appearance:a.DEFAULT,size:c.BODY},argTypes:{appearance:{control:"select",options:Object.values(a)},size:{control:"select",options:Object.values(c)},default:{control:!1},icon:{control:!1}},render:i=>({components:{UiLink:l},setup(){return{args:i}},template:`
      <UiLink v-bind="args">
          Hyperlink
      </UiLink>
    `}),parameters:{docs:{page:v},layout:"centered"}},r={};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"{}",...r.parameters?.docs?.source}}};const F=["Sandbox"];export{r as Sandbox,F as __namedExportsOrder,B as default};
