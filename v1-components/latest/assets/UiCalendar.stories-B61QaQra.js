import{h as v,r as i,y as P,o as d,c as m,m as k,a as r,t as h,j as S,D as j,K as x,S as R,a8 as T,a9 as M,w as V}from"./iframe-7PfFZbMo.js";import{_ as c,A as _,T as N}from"./UiCalendar-ByURgXAy.js";import{o as W}from"./utils-BqzVSXwn.js";import{j as n}from"./jsx-runtime-oUFsCJCe.js";import{useMDXComponents as $}from"./index-nKJCzsSA.js";import{A as X}from"./blocks-DxbhbOcf.js";import{T as p}from"./ToReact-zb7Edybv.js";import"./preload-helper-PPVm8Dsz.js";import"./chevron-right-CJWBbB1_.js";import"./UiButton-mr2D0Bmz.js";import"./predicate-ClulhfEu.js";import"./composables-DmHLbFXN.js";import"./plugin-mT4wte91.js";import"./index-BAxMPZdI.js";import"./index-a22oIHiu.js";const B=v({__name:"UiCalendar.single.example",setup(s){const e=i(new Date);return(t,a)=>(d(),P(c,{value:e.value,"onUpdate:value":a[0]||(a[0]=o=>e.value=o)},null,8,["value"]))}});B.__docgenInfo={exportName:"default",displayName:"UiCalendar.single.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiCalendar.single.example.vue"]};const O=v({__name:"UiCalendar.range.example",setup(s){const e=i([new Date("2024-11-10"),new Date("2024-11-19")]);return(t,a)=>(d(),P(c,{value:e.value,"onUpdate:value":a[0]||(a[0]=o=>e.value=o),type:"range"},null,8,["value"]))}});O.__docgenInfo={exportName:"default",displayName:"UiCalendar.range.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiCalendar.range.example.vue"]};const Y={style:{display:"grid",gap:"12px",width:"320px"}},H={key:0},K={key:1},L=v({__name:"UiCalendar.nullable.example",setup(s){const e=i(new Date("2024-11-21"));return(t,a)=>(d(),m("div",Y,[k(c,{value:e.value,"onUpdate:value":a[0]||(a[0]=o=>e.value=o),nullable:""},null,8,["value"]),r("div",null,[a[1]||(a[1]=r("strong",null,"Value:",-1)),e.value?(d(),m("span",H,h(e.value.toDateString()),1)):(d(),m("span",K," null "))])]))}});L.__docgenInfo={exportName:"default",displayName:"UiCalendar.nullable.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiCalendar.nullable.example.vue"]};const q={style:{display:"grid",gap:"12px",width:"320px"}},G=v({__name:"UiCalendar.bounds.example",setup(s){const e=new Date("2024-11-05"),t=new Date("2024-11-25"),a=i([new Date("2024-11-10"),new Date("2024-11-19")]),o=S(()=>a.value.length===0?"[]":a.value.length===1?`[${a.value[0].toDateString()}]`:`[${a.value[0].toDateString()} - ${a.value[1].toDateString()}]`);return(E,l)=>(d(),m("div",q,[k(c,{value:a.value,"onUpdate:value":l[0]||(l[0]=u=>a.value=u),type:"range","min-date":j(e),"max-date":j(t)},null,8,["value","min-date","max-date"]),r("div",null,[l[1]||(l[1]=r("strong",null,"Min:",-1)),x(" "+h(j(e).toDateString()),1)]),r("div",null,[l[2]||(l[2]=r("strong",null,"Max:",-1)),x(" "+h(j(t).toDateString()),1)]),r("div",null,[l[3]||(l[3]=r("strong",null,"Value:",-1)),x(" "+h(o.value),1)])]))}});G.__docgenInfo={exportName:"default",displayName:"UiCalendar.bounds.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiCalendar.bounds.example.vue"]};const z={style:{display:"grid",gap:"12px"}},I=v({__name:"UiCalendar.double-range.example",setup(s){const e=i([new Date("2024-11-10"),new Date("2024-12-08")]),t=S(()=>e.value.length===0?"[]":e.value.length===1?`[${e.value[0].toDateString()}]`:`[${e.value[0].toDateString()} - ${e.value[1].toDateString()}]`);return(a,o)=>(d(),m("div",z,[k(c,{value:e.value,"onUpdate:value":o[0]||(o[0]=E=>e.value=E),appearance:"double",type:"range"},null,8,["value"]),r("div",null,[o[1]||(o[1]=r("strong",null,"Value:",-1)),x(" "+h(t.value),1)])]))}});I.__docgenInfo={exportName:"default",displayName:"UiCalendar.double-range.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiCalendar.double-range.example.vue"]};const J={style:{display:"grid",gap:"12px"}},Q={style:{display:"flex",gap:"8px","align-items":"center","flex-wrap":"wrap"}},F=v({__name:"UiCalendar.locale.example",setup(s){const e=i(new Date("2024-11-21")),t=i("en-GB"),a=i("auto"),o=S(()=>a.value==="auto"?void 0:Number(a.value));return(E,l)=>(d(),m("div",J,[r("div",Q,[r("label",null,[l[4]||(l[4]=x(" Locale ",-1)),R(r("select",{"onUpdate:modelValue":l[0]||(l[0]=u=>t.value=u)},[...l[3]||(l[3]=[r("option",{value:"en-GB"},"en-GB",-1),r("option",{value:"es-ES"},"es-ES",-1),r("option",{value:"ru-RU"},"ru-RU",-1)])],512),[[T,t.value]])]),r("label",null,[l[6]||(l[6]=x(" First day ",-1)),R(r("select",{"onUpdate:modelValue":l[1]||(l[1]=u=>a.value=u)},[...l[5]||(l[5]=[M('<option value="auto">auto</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option>',8)])],512),[[T,a.value]])])]),k(c,{value:e.value,"onUpdate:value":l[2]||(l[2]=u=>e.value=u),locale:t.value,"first-day-of-week":o.value},null,8,["value","locale","first-day-of-week"])]))}});F.__docgenInfo={exportName:"default",displayName:"UiCalendar.locale.example",description:"",tags:{},sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiCalendar.locale.example.vue"]};function A(s){const e={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...$(),...s.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"uicalendar",children:"UiCalendar"}),`
