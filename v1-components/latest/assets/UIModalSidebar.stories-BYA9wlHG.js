...
`]})]})}function I(o={}){const{wrapper:n}={...y(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(S,{...o})}):S(o)}const J={title:"Components/UiModalSidebar",component:j,args:{direction:g.RIGHT,fixed:!1,scrolling:b.NORMAL,size:v.SM},argTypes:{opened:{control:!1},id:{control:!1},direction:{control:"select",options:Object.values(g)},scrolling:{control:"select",options:Object.values(b)},size:{control:"select",options:Object.values(v)}},render:o=>({components:{UiButton:x,UiModalSidebar:j},setup(){return{args:o,opened:m(!1)}},template:`
      <div>
