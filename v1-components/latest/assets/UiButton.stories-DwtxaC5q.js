import{I as m}from"./add-7oY7PnN7.js";import{_ as i,V as o,S as d,A as l}from"./UiButton-BCon8_Cd.js";import{u as h,j as e}from"./index-DFg_Ho_i.js";import{T as s}from"./ToReact-DbRAeBf3.js";import{h as j,y as p,z as g,L as f,M as y,o as c,c as I,E as v,H as x,N as w,t as b,F as B}from"./iframe-DnG3g5pW.js";import{I as k}from"./done-B176HZ5x.js";import"./predicate-ClulhfEu.js";import"./render-vaNyDQt4.js";import"./composables-CfEvSTVp.js";import"./index-nl1gzEpR.js";import"./preload-helper-PPVm8Dsz.js";const n=j({__name:"UiButton.example",props:{text:{type:String,default:""},showIcon:{type:Boolean,default:!1}},setup(a){return(t,N)=>(c(),p(i,f(y(t.$attrs)),{default:g(()=>[a.text.length?(c(),I(B,{key:0},[a.showIcon?(c(),p(v(k),{key:0})):x("",!0),w(" "+b(a.text),1)],64)):x("",!0)]),_:1},16))}});n.__docgenInfo=Object.assign({displayName:n.name??n.__name},{exportName:"default",displayName:"UiButton.example",description:"",tags:{},props:[{name:"text",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"showIcon",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],sourceFiles:["/home/runner/work/embed-ui/embed-ui/packages/v1-components/storybook/stories/UiButton.example.vue"]});function u(a){const t={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...h(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"uibutton",children:"UiButton"}),`
...
<\/script>
`})})]})}function A(a={}){const{wrapper:t}={...h(),...a.components};return t?e.jsx(t,{...a,children:e.jsx(u,{...a})}):u(a)}const O={title:"Components/UiButton",component:i,args:{appearance:l.PRIMARY,size:d.SM,variant:o.DEFAULT},argTypes:{href:{control:"text"},appearance:{control:"select",options:Object.values(l)},size:{control:"select",options:Object.values(d)},variant:{control:"select",options:Object.values(o)}},render:a=>({components:{IconAdd:m,UiButton:i},setup(){return{args:a}},template:`
    ...
    `}),parameters:{docs:{page:A},layout:"centered"}},r={};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"{}",...r.parameters?.docs?.source}}};const R=["Sandbox"];export{r as Sandbox,R as __namedExportsOrder,O as default};
