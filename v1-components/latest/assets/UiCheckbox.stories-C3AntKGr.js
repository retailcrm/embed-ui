...
`,l.jsx(D,{})]})}function R(i={}){const{wrapper:e}={...C(),...i.components};return e?l.jsx(e,{...i,children:l.jsx(g,{...i})}):g(i)}const le={title:"Components/UiCheckbox",component:d,argTypes:{id:{control:!1}},render:i=>({components:{UiCheckbox:d},setup(){return{model:m(i.model),props:u(()=>A(i,["id","model"]))}},template:`
      <UiCheckbox
          id="checkbox"
          v-model:model="model"
          v-bind="props"
