...
`,n.jsx(G,{})]})}function B(r={}){const{wrapper:e}={...E(),...r.components};return e?n.jsx(e,{...r,children:n.jsx(k,{...r})}):k(r)}const K={title:"Components/UiSlider",component:p,args:{value:20,type:o.SINGLE,min:0,max:100,labelled:!1},argTypes:{value:{control:!1},type:{control:"select",options:Object.values(o)},min:{control:"number"},max:{control:"number"},labelled:{control:"boolean"},label:{control:!1},handle:{control:!1}},render:r=>({components:{UiSlider:p},setup(){const e=v(r.value??20);return w(()=>r.type,d=>{d===o.RANGE&&!Array.isArray(e.value)&&(e.value=[r.min??0,r.max??100]),d===o.SINGLE&&Array.isArray(e.value)&&(e.value=e.value[0]??r.min??0)},{immediate:!0}),w(()=>r.value,d=>{typeof d<"u"&&(e.value=d)}),{value:e,props:R(()=>T(r,["value"]))}},template:`
    ...
    `}),parameters:{docs:{page:B},layout:"centered"}},h={},j={args:{type:o.RANGE,value:[20,80]}},g={args:{labelled:!0}},b={args:{labelled:!0,type:o.RANGE,value:[25,65]}},y={args:{type:o.RANGE,min:10,max:60,value:[0,80]}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:"{}",...h.parameters?.docs?.source}}};j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  args: {
    type: TYPE.RANGE,
    value: [20, 80]
  }
