...
const term = ref('')
<\/script>
`})})]})}function D(i={}){const{wrapper:n}={...g(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(u,{...i})}):u(i)}const W={title:"Components/UiTextbox",component:r,args:{id:void 0,type:j.TEXT,value:"",placeholder:"Enter text",size:h.SM,width:_.FIT,prefix:"https://",suffix:"₽",active:!1,invalid:!1,multiline:!1,autofit:!1},argTypes:{id:{control:!1},type:{control:"select",options:Object.values(j)},value:{control:"text"},width:{control:"text"},size:{control:"select",options:Object.values(h)},inputmode:{control:"select",options:Object.values(S)}},render:i=>({components:{IconCaret:f,IconSearch:v,UiTextbox:r},setup(){const{value:n}=i;return{value:m(String(n)),props:N(()=>b(i,["value"]))}},template:`
      <UiTextbox
          v-model:value="value"
          v-bind="props"
      >
    ...
    `}),parameters:{docs:{page:D},layout:"centered"}},l={};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"{}",...l.parameters?.docs?.source}}};const H=["Sandbox"];export{l as Sandbox,H as __namedExportsOrder,W as default};
