...
- `__SOURCE_ROOT__/sandbox/tests/` with starter unit, browser, and e2e tests.
- `vitest.config.ts`, `vitest.config.browser.ts`, and `vitest.config.playwright.ts` for test runs.
