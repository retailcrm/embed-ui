...
Los servidores locales funcionan sin `.env.sandbox`. Use `SANDBOX_BASE_URL` y
`SANDBOX_EXTENSION_URL` para seleccionar servidores ya iniciados en otras direcciones.
