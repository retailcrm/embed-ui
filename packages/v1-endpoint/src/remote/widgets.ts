...
import type { RunConfig } from '@/common/widgets'
import type { RunIdentity } from '@/common/widgets'
...
export const defineMultiRunner = (runners: Partial<Record<TargetName, Runner>>): Runner => ({
  async run (createApp, root, pinia, target) {
