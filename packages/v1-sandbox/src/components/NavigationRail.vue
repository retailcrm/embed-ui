<template>
    <aside
        :id="uid + '-navigation-rail'"
        :class="$style['navigation-rail']"
    >
        <div
            :class="$style['navigation-rail__logo']"
        />

        <ul :class="$style['navigation-rail__list']">
            <li
        ...
        <div :class="$style['navigation-rail__spacer']" />
        ...
        <div
            :class="$style['navigation-rail__user']"
        >
            <span :class="$style['navigation-rail__user-skeleton']" />
        </div>
    </aside>
</template>
